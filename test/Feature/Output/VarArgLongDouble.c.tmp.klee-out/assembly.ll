; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/VarArgLongDouble.c.tmp.bc'
...
define void @ld_after_zero(i32 %first, ...) #0 {
  %1 = alloca i32, align 4
  %ap = alloca [1 x %struct.__va_list_tag], align 16
  %dub = alloca x86_fp80, align 16
  store i32 %first, i32* %1, align 4
...
; <label>:25                                      ; preds = %20
  ...
  %28 = load i8** %27
  %29 = getelementptr i8* %28, i64 15
  %30 = ptrtoint i8* %29 to i64
  %31 = and i64 %30, -16
  %32 = inttoptr i64 %31 to i8*
  %33 = bitcast i8* %32 to x86_fp80*
  %34 = getelementptr i8* %32, i32 16
  store i8* %34, i8** %27
  %35 = load x86_fp80* %33
  store x86_fp80 %35, x86_fp80* %dub, align 16
  %36 = load x86_fp80* %dub, align 16
  %37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), x86_fp80 %36)
  ret void
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store x86_fp80 0xK3FFF8FCD67FD3F5B6000, x86_fp80* %dub, align 16
  store i32 0, i32* %zero, align 4
  store i32 1, i32* %one, align 4
  %2 = load i32* %one, align 4
  %3 = load i32* %zero, align 4
  %4 = load x86_fp80* %dub, align 16
  call void (i32, ...)* @ld_after_zero(i32 %2, i32 %3, x86_fp80 %4)
  %5 = load i32* %one, align 4
  %6 = load i32* %one, align 4
  %7 = load i32* %zero, align 4
  %8 = load x86_fp80* %dub, align 16
  call void (i32, ...)* @ld_after_zero(i32 %5, i32 %6, i32 %7, x86_fp80 %8)
  ret i32 0
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str1, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #7, !dbg !123
  unreachable, !dbg !123
