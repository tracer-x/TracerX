; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/RaiseAsm.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [5 x i8] c"ui16\00", align 1
@.str1 = private unnamed_addr constant [5 x i8] c"ui32\00", align 1
@.str2 = private unnamed_addr constant [51 x i8] c"ui16 == byteswap_uint16(byteswap_uint16_asm(ui16))\00", align 1
@.str3 = private unnamed_addr constant [53 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/RaiseAsm.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str4 = private unnamed_addr constant [51 x i8] c"ui32 == byteswap_uint32(byteswap_uint32_asm(ui32))\00", align 1
...
define zeroext i16 @byteswap_uint16(i16 zeroext %x) #0 {
...
; Function Attrs: nounwind uwtable
define i32 @byteswap_uint32(i32 %x) #0 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %3 = trunc i32 %2 to i16
  %4 = call zeroext i16 @byteswap_uint16(i16 zeroext %3)
  %5 = zext i16 %4 to i32
  ...
  %8 = lshr i32 %7, 16
  %9 = trunc i32 %8 to i16
  %10 = call zeroext i16 @byteswap_uint16(i16 zeroext %9)
...
; Function Attrs: nounwind uwtable
define zeroext i16 @byteswap_uint16_asm(i16 zeroext %x) #0 {
  %1 = alloca i16, align 2
  ...
  store i16 %bswap.i16, i16* %res, align 2
  %3 = load i16* %res, align 2
  ret i16 %3
}

; Function Attrs: nounwind uwtable
define i32 @byteswap_uint32_asm(i32 %x) #0 {
  %1 = alloca i32, align 4
  %res = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = load i32* %1, align 4
  %bswap.4 = shl i32 %2, 24
  %bswap.3 = shl i32 %2, 8
  %bswap.2 = lshr i32 %2, 8
  %bswap.1 = lshr i32 %2, 24
  ...
  store i32 %bswap.i32, i32* %res, align 4
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i8*, ...)* bitcast (i32 (i8*)* @klee_int to i32 (i8*, ...)*)(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0))
  %3 = trunc i32 %2 to i16
  store i16 %3, i16* %ui16, align 2
  %4 = call i32 (i8*, ...)* bitcast (i32 (i8*)* @klee_int to i32 (i8*, ...)*)(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0))
  store i32 %4, i32* %ui32, align 4
  %5 = load i16* %ui16, align 2
  %6 = zext i16 %5 to i32
  %7 = load i16* %ui16, align 2
  %8 = call zeroext i16 @byteswap_uint16_asm(i16 zeroext %7)
  %9 = call zeroext i16 @byteswap_uint16(i16 zeroext %8)
...
; <label>:13                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([51 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8]* @.str3, i32 0, i32 0), i32 36, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %15

; <label>:15                                      ; preds = %14, %12
  %16 = load i32* %ui32, align 4
  %17 = load i32* %ui32, align 4
  %18 = call i32 @byteswap_uint32_asm(i32 %17)
  %19 = call i32 @byteswap_uint32(i32 %18)
...
; <label>:22                                      ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([51 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8]* @.str3, i32 0, i32 0), i32 37, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %24
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str5, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str16, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str27, i64 0, i64 0)) #7, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #8, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str38, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #8, !dbg !141
