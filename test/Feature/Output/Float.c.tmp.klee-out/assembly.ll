; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/Float.c.tmp.bc'
...
define float @fadd(float %a, float %b) #0 {
  ...
  %3 = load float* %1, align 4, !dbg !134
  %4 = load float* %2, align 4, !dbg !134
  %5 = fadd float %3, %4, !dbg !134
  ret float %5, !dbg !134
}
...
define float @fsub(float %a, float %b) #0 {
  ...
  store float %a, float* %1, align 4
  store float %b, float* %2, align 4
  %3 = load float* %1, align 4, !dbg !135
  %4 = load float* %2, align 4, !dbg !135
  %5 = fsub float %3, %4, !dbg !135
  ret float %5, !dbg !135
}
...
define float @fmul(float %a, float %b) #0 {
  ...
  store float %a, float* %1, align 4
  store float %b, float* %2, align 4
  %3 = load float* %1, align 4, !dbg !136
  %4 = load float* %2, align 4, !dbg !136
  %5 = fmul float %3, %4, !dbg !136
  ret float %5, !dbg !136
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call float @fadd(float 0x3FF19999A0000000, float 0x40019999A0000000), !dbg !137
  %3 = fpext float %2 to double, !dbg !137
  %4 = call float @fsub(float 0x3FF19999A0000000, float 0x40019999A0000000), !dbg !137
  %5 = fpext float %4 to double, !dbg !137
  %6 = call float @fmul(float 0x3FF19999A0000000, float 0x40019999A0000000), !dbg !137
  %7 = fpext float %6 to double, !dbg !137
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), double %3, double %5, double %7), !dbg !137
  ret i32 0, !dbg !138
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str1, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #6, !dbg !141
  unreachable, !dbg !141
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #7, !dbg !143
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !151
  unreachable, !dbg !151
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #6, !dbg !156
  unreachable, !dbg !156
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #7, !dbg !159
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/Float.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !9, metadata !10, metadata !11}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"fadd", metadata !"fadd", metadata !"", i32 8, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, float (float, float)* @fadd, null, null, metadata !2, i32 8} ; [ DW_TAG_
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/Float.c]
...
!9 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"fsub", metadata !"fsub", metadata !"", i32 12, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, float (float, float)* @fsub, null, null, metadata !2, i32 12} ; [ DW_TA
!10 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"fmul", metadata !"fmul", metadata !"", i32 16, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, float (float, float)* @fmul, null, null, metadata !2, i32 16} ; [ DW_T
!11 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 20, metadata !12, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 20} ; [ DW_TAG_subprogram ]
...
!33 = metadata !{metadata !14, metadata !34}
...
!39 = metadata !{i32 786688, metadata !29, metadata !"x", metadata !31, i32 14, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [x] [line 14]
...
!59 = metadata !{metadata !14, metadata !14, metadata !14, metadata !34}
!60 = metadata !{metadata !61, metadata !62, metadata !63, metadata !64}
!61 = metadata !{i32 786689, metadata !55, metadata !"start", metadata !57, i32 16777229, metadata !14, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [start] [line 13]
!62 = metadata !{i32 786689, metadata !55, metadata !"end", metadata !57, i32 33554445, metadata !14, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [end] [line 13]
...
!64 = metadata !{i32 786688, metadata !55, metadata !"x", metadata !57, i32 14, metadata !14, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [x] [line 14]
...
!122 = metadata !{metadata !73, metadata !73, metadata !14, metadata !123}
...
!126 = metadata !{i32 786689, metadata !118, metadata !"s", metadata !120, i32 33554443, metadata !14, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [s] [line 11]
...
!135 = metadata !{i32 13, i32 0, metadata !9, null}
!136 = metadata !{i32 17, i32 0, metadata !10, null}
!137 = metadata !{i32 21, i32 0, metadata !11, null}
!138 = metadata !{i32 22, i32 0, metadata !11, null}
...
!150 = metadata !{i32 786443, metadata !44, metadata !43, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!151 = metadata !{i32 27, i32 0, metadata !152, null}
!152 = metadata !{i32 786443, metadata !44, metadata !150, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!153 = metadata !{i32 29, i32 0, metadata !43, null}
!154 = metadata !{i32 16, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !56, metadata !55, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!156 = metadata !{i32 17, i32 0, metadata !155, null}
!157 = metadata !{i32 19, i32 0, metadata !158, null}
!158 = metadata !{i32 786443, metadata !56, metadata !55, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!159 = metadata !{i32 22, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !56, metadata !158, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!161 = metadata !{i32 25, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !56, metadata !160, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 26, i32 0, metadata !164, null}
!164 = metadata !{i32 786443, metadata !56, metadata !162, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!165 = metadata !{i32 27, i32 0, metadata !164, null}
!166 = metadata !{i32 28, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !56, metadata !162, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!168 = metadata !{i32 29, i32 0, metadata !167, null}
!169 = metadata !{i32 32, i32 0, metadata !160, null}
!170 = metadata !{i32 34, i32 0, metadata !55, null}
!171 = metadata !{i32 16, i32 0, metadata !68, null}
!172 = metadata !{i32 17, i32 0, metadata !68, null}
...
!178 = metadata !{i32 18, i32 0, metadata !68, null}
!179 = metadata !{i32 16, i32 0, metadata !180, null}
!180 = metadata !{i32 786443, metadata !89, metadata !88, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!181 = metadata !{i32 19, i32 0, metadata !182, null}
!182 = metadata !{i32 786443, metadata !89, metadata !88, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!183 = metadata !{i32 20, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !89, metadata !182, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!188 = metadata !{i32 786443, metadata !89, metadata !182, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!193 = metadata !{i32 28, i32 0, metadata !88, null}
!194 = metadata !{i32 15, i32 0, metadata !103, null}
!195 = metadata !{i32 16, i32 0, metadata !103, null}
!196 = metadata !{metadata !196, metadata !174, metadata !175}
!197 = metadata !{metadata !197, metadata !174, metadata !175}
!198 = metadata !{i32 17, i32 0, metadata !103, null}
!199 = metadata !{i32 13, i32 0, metadata !118, null}
!200 = metadata !{i32 14, i32 0, metadata !118, null}
!201 = metadata !{i32 15, i32 0, metadata !118, null}
