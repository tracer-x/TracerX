; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/DefineFixedObject.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i32, ...)* bitcast (i32 (...)* @klee_define_fixed_object to i32 (i32*, i32, ...)*)(i32* inttoptr (i64 128 to i32*), i32 4)
  store i32* inttoptr (i64 128 to i32*), i32** %p, align 8
  %3 = load i32** %p, align 8
  store i32 10, i32* %3, align 4
  %4 = load i32** %p, align 8
  %5 = load i32* %4, align 4
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i32 %5)
  ret i32 0
}

declare i32 @klee_define_fixed_object(...) #1
