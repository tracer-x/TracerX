; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/OvershiftCheck.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [14 x i8] c"shift_amount1\00", align 1
@.str1 = private unnamed_addr constant [14 x i8] c"shift_amount2\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i32 15, i32* %x, align 4, !dbg !128
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %y, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0)), !dbg !129
  %3 = load i32* %x, align 4, !dbg !130
  %4 = load i32* %y, align 4, !dbg !130
  %int_cast_to_i64 = zext i32 %4 to i64
  call void @klee_overshift_check(i64 32, i64 %int_cast_to_i64), !dbg !130
  %5 = shl i32 %3, %4, !dbg !130
  store volatile i32 %5, i32* %result, align 4, !dbg !130
  %6 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %z, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)), !dbg !131
  %7 = load i32* %x, align 4, !dbg !132
  %8 = load i32* %z, align 4, !dbg !132
  %int_cast_to_i641 = zext i32 %8 to i64
  call void @klee_overshift_check(i64 32, i64 %int_cast_to_i641), !dbg !132
  %9 = lshr i32 %7, %8, !dbg !132
  store volatile i32 %9, i32* %result, align 4, !dbg !132
  ret i32 0, !dbg !133
}
...
define void @klee_div_zero_check(i64 %z) #3 {
  %1 = icmp eq i64 %z, 0, !dbg !134
  br i1 %1, label %2, label %3, !dbg !134

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #6, !dbg !136
  unreachable, !dbg !136
...
define i32 @klee_int(i8* %name) #3 {
  %x = alloca i32, align 4
  %1 = bitcast i32* %x to i8*, !dbg !138
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #7, !dbg !138
  %2 = load i32* %x, align 4, !dbg !139, !tbaa !140
  ret i32 %2, !dbg !139
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #3 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !144
  br i1 %1, label %3, label %2, !dbg !144

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !146
  unreachable, !dbg !146
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #3 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !149
  br i1 %1, label %3, label %2, !dbg !149

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #6, !dbg !151
  unreachable, !dbg !151

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !152
  %5 = icmp eq i32 %4, %end, !dbg !152
  br i1 %5, label %21, label %6, !dbg !152

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !154
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #7, !dbg !154
  %8 = icmp eq i32 %start, 0, !dbg !156
  %9 = load i32* %x, align 4, !dbg !158, !tbaa !140
  br i1 %8, label %10, label %13, !dbg !156

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !158
  %12 = zext i1 %11 to i64, !dbg !158
  call void @klee_assume(i64 %12) #7, !dbg !158
  br label %19, !dbg !160

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !161
  %15 = zext i1 %14 to i64, !dbg !161
  call void @klee_assume(i64 %15) #7, !dbg !161
  %16 = load i32* %x, align 4, !dbg !163, !tbaa !140
  %17 = icmp slt i32 %16, %end, !dbg !163
  %18 = zext i1 %17 to i64, !dbg !163
  call void @klee_assume(i64 %18) #7, !dbg !163
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !164, !tbaa !140
  br label %21, !dbg !164
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  %1 = icmp eq i64 %len, 0, !dbg !166
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !166
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !167
  %wide.load = load <16 x i8>* %3, align 1, !dbg !167
  %next.gep.sum279 = or i64 %index, 16, !dbg !167
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !167
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !167
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !167
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !167
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !167
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !167
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !167
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !167
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !166
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !167
  %12 = load i8* %src.03, align 1, !dbg !167, !tbaa !171
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !167
  store i8 %12, i8* %dest.02, align 1, !dbg !167, !tbaa !171
  %14 = icmp eq i64 %10, 0, !dbg !166
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !166, !llvm.loop !172

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !173
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #3 {
  %1 = icmp eq i8* %src, %dst, !dbg !174
  br i1 %1, label %.loopexit, label %2, !dbg !174

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !176
  br i1 %3, label %.preheader, label %18, !dbg !176

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !178
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !178
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !178
  %wide.load = load <16 x i8>* %6, align 1, !dbg !178
  %next.gep.sum586 = or i64 %index, 16, !dbg !178
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !178
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !178
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !178
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !178
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !178
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !178
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !178
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !178
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !180
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !178
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !178
  %15 = load i8* %b.04, align 1, !dbg !178, !tbaa !171
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !178
  store i8 %15, i8* %a.03, align 1, !dbg !178, !tbaa !171
  %17 = icmp eq i64 %13, 0, !dbg !178
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !178, !llvm.loop !181

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !182
  %20 = icmp eq i64 %count, 0, !dbg !184
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !184

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !185
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !182
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !184
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !184
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !184
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !184
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !184
  %.sum505 = add i64 %.sum440, -31, !dbg !184
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !184
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !184
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !184
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !184
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !184
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !184
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !184
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !184
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !184
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !184
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !184
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !184
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !186
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !184
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !184
  %34 = load i8* %b.18, align 1, !dbg !184, !tbaa !171
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !184
  store i8 %34, i8* %a.17, align 1, !dbg !184, !tbaa !171
  %36 = icmp eq i64 %32, 0, !dbg !184
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !184, !llvm.loop !187
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  ...
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !189
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum280 = or i64 %index, 16, !dbg !190
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !190
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !190
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !190
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !190
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !190
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !190
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !190
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !190
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !190, !tbaa !171
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !190
  store i8 %12, i8* %dest.02, align 1, !dbg !190, !tbaa !171
  %14 = icmp eq i64 %10, 0, !dbg !189
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !189, !llvm.loop !192
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !193
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #3 {
  %1 = icmp eq i64 %count, 0, !dbg !194
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !194

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !195
  br label %3, !dbg !194

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !194
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !195
  store volatile i8 %2, i8* %a.02, align 1, !dbg !195, !tbaa !171
  %6 = icmp eq i64 %4, 0, !dbg !194
  br i1 %6, label %._crit_edge, label %3, !dbg !194
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/OvershiftCheck.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 11, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 12} ; [ DW_TAG_subprogram ] [
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/OvershiftCheck.c]
...
!129 = metadata !{i32 19, i32 0, metadata !4, null}
!130 = metadata !{i32 20, i32 0, metadata !4, null}
!131 = metadata !{i32 23, i32 0, metadata !4, null}
!132 = metadata !{i32 24, i32 0, metadata !4, null}
!133 = metadata !{i32 26, i32 0, metadata !4, null}
!134 = metadata !{i32 13, i32 0, metadata !135, null}
!135 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!136 = metadata !{i32 14, i32 0, metadata !135, null}
!137 = metadata !{i32 15, i32 0, metadata !12, null}
!138 = metadata !{i32 15, i32 0, metadata !23, null}
!139 = metadata !{i32 16, i32 0, metadata !23, null}
!140 = metadata !{metadata !141, metadata !141, i64 0}
!141 = metadata !{metadata !"int", metadata !142, i64 0}
!142 = metadata !{metadata !"omnipotent char", metadata !143, i64 0}
!143 = metadata !{metadata !"Simple C/C++ TBAA"}
!144 = metadata !{i32 21, i32 0, metadata !145, null}
!145 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!146 = metadata !{i32 27, i32 0, metadata !147, null}
!147 = metadata !{i32 786443, metadata !38, metadata !145, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!148 = metadata !{i32 29, i32 0, metadata !37, null}
!149 = metadata !{i32 16, i32 0, metadata !150, null}
!150 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!151 = metadata !{i32 17, i32 0, metadata !150, null}
!152 = metadata !{i32 19, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!154 = metadata !{i32 22, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !50, metadata !153, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!156 = metadata !{i32 25, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !50, metadata !155, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!158 = metadata !{i32 26, i32 0, metadata !159, null}
!159 = metadata !{i32 786443, metadata !50, metadata !157, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!160 = metadata !{i32 27, i32 0, metadata !159, null}
!161 = metadata !{i32 28, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !50, metadata !157, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 29, i32 0, metadata !162, null}
!164 = metadata !{i32 32, i32 0, metadata !155, null}
!165 = metadata !{i32 34, i32 0, metadata !49, null}
!166 = metadata !{i32 16, i32 0, metadata !62, null}
!167 = metadata !{i32 17, i32 0, metadata !62, null}
!168 = metadata !{metadata !168, metadata !169, metadata !170}
!169 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!170 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!171 = metadata !{metadata !142, metadata !142, i64 0}
!172 = metadata !{metadata !172, metadata !169, metadata !170}
!173 = metadata !{i32 18, i32 0, metadata !62, null}
!174 = metadata !{i32 16, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!176 = metadata !{i32 19, i32 0, metadata !177, null}
!177 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!178 = metadata !{i32 20, i32 0, metadata !179, null}
!179 = metadata !{i32 786443, metadata !83, metadata !177, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!180 = metadata !{metadata !180, metadata !169, metadata !170}
!181 = metadata !{metadata !181, metadata !169, metadata !170}
!182 = metadata !{i32 22, i32 0, metadata !183, null}
!183 = metadata !{i32 786443, metadata !83, metadata !177, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!184 = metadata !{i32 24, i32 0, metadata !183, null}
!185 = metadata !{i32 23, i32 0, metadata !183, null}
!186 = metadata !{metadata !186, metadata !169, metadata !170}
!187 = metadata !{metadata !187, metadata !169, metadata !170}
!188 = metadata !{i32 28, i32 0, metadata !82, null}
!189 = metadata !{i32 15, i32 0, metadata !97, null}
!190 = metadata !{i32 16, i32 0, metadata !97, null}
!191 = metadata !{metadata !191, metadata !169, metadata !170}
!192 = metadata !{metadata !192, metadata !169, metadata !170}
!193 = metadata !{i32 17, i32 0, metadata !97, null}
!194 = metadata !{i32 13, i32 0, metadata !112, null}
!195 = metadata !{i32 14, i32 0, metadata !112, null}
!196 = metadata !{i32 15, i32 0, metadata !112, null}
