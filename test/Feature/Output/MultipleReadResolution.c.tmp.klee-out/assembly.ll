; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/MultipleReadResolution.c.tmp1.bc'
...
; <label>:30                                      ; preds = %29, %16
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0))
  %32 = load %struct._IO_FILE** @stdout, align 8
