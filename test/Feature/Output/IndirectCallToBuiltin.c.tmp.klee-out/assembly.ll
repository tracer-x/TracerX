; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/IndirectCallToBuiltin.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"mem: %p\0A\00", align 1
@.str1 = private unnamed_addr constant [12 x i8] c"mem[0]: %d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %allocator = alloca i8* (i64)*, align 8
  %mem = alloca i32*, align 8
  store i32 0, i32* %1
  store i8* (i64)* @malloc, i8* (i64)** %allocator, align 8, !dbg !128
  %2 = load i8* (i64)** %allocator, align 8, !dbg !129
  %3 = call i8* %2(i64 10), !dbg !129
  %4 = bitcast i8* %3 to i32*, !dbg !129
  store i32* %4, i32** %mem, align 8, !dbg !129
  %5 = load i32** %mem, align 8, !dbg !130
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32* %5), !dbg !130
  %7 = load i32** %mem, align 8, !dbg !131
  %8 = getelementptr inbounds i32* %7, i64 0, !dbg !131
  %9 = load i32* %8, align 4, !dbg !131
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str1, i32 0, i32 0), i32 %9), !dbg !131
  ret i32 0, !dbg !132
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #7, !dbg !135
  unreachable, !dbg !135
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !145
  unreachable, !dbg !145
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/IndirectCallToBuiltin.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/IndirectCallToBuiltin.c]
...
!131 = metadata !{i32 13, i32 0, metadata !4, null}
