; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/SolverTimeout.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"x\00", align 1
@.str1 = private unnamed_addr constant [5 x i8] c"Yes\0A\00", align 1
@.str2 = private unnamed_addr constant [4 x i8] c"No\0A\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i64 7719234, i64* %y, align 8
  store i64 101, i64* %i, align 8
  %2 = call i32 (i64*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i64*, i64, i8*, ...)*)(i64* %x, i64 8, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  ...
  %int_cast_to_i64 = bitcast i64 %38 to i64
  ...
  %46 = load i64* %y, align 8
  %47 = mul nsw i64 %45, %46
  %48 = load i64* %y, align 8
  %49 = mul nsw i64 %47, %48
  %50 = load i64* %y, align 8
  %51 = mul nsw i64 %49, %50
  %52 = load i64* %y, align 8
  %53 = mul nsw i64 %51, %52
  %54 = load i64* %y, align 8
  %55 = mul nsw i64 %53, %54
  %56 = load i64* %y, align 8
  %57 = mul nsw i64 %55, %56
  %58 = load i64* %y, align 8
  %59 = mul nsw i64 %57, %58
  %60 = load i64* %y, align 8
  %61 = mul nsw i64 %59, %60
  %62 = load i64* %y, align 8
  %63 = mul nsw i64 %61, %62
  %64 = load i64* %y, align 8
  %65 = mul nsw i64 %63, %64
  %66 = load i64* %y, align 8
  %67 = mul nsw i64 %65, %66
  %68 = load i64* %y, align 8
  %69 = mul nsw i64 %67, %68
  %70 = load i64* %y, align 8
  %71 = mul nsw i64 %69, %70
  %72 = load i64* %i, align 8
  %int_cast_to_i641 = bitcast i64 %72 to i64
...
; <label>:75                                      ; preds = %0
  %76 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0))
  br label %79

; <label>:77                                      ; preds = %0
  %78 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0))
  br label %79
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str3, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #2 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #7, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str36, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str147, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str258, i64 0, i64 0)) #6, !dbg !133
  unreachable, !dbg !133
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #7, !dbg !141
