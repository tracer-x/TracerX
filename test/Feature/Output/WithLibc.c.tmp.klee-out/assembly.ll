; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/WithLibc.c.tmp2.bc'
...
@.str1 = private unnamed_addr constant [6 x i8] c"good\0A\00", align 1
@.str2 = private unnamed_addr constant [5 x i8] c"bad\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %2 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0
  %3 = call i32 (i8*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i64, ...)*)(i8* %2, i64 4)
  %4 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 3
  store i8 0, i8* %4, align 1
  %5 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0
  %6 = load i8** %s, align 8
...
; <label>:9                                       ; preds = %0
  %10 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 0
...
; <label>:14                                      ; preds = %9
  %15 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 1
...
; <label>:19                                      ; preds = %14
  %20 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 2
...
; <label>:24                                      ; preds = %19
  %25 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 3
...
; <label>:29                                      ; preds = %24
  %30 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0))
  br label %33

; <label>:31                                      ; preds = %24, %19, %14, %9
  %32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0))
  br label %33
...
; Function Attrs: nounwind uwtable
define i32 @__cxa_atexit(void (i8*)* %fn, i8* %arg, i8* nocapture readnone %dso_handle) #2 {
  tail call void @klee_warning_once(i8* getelementptr inbounds ([34 x i8]* @.str3, i64 0, i64 0)) #9, !dbg !509
  %1 = load i32* @NumAtExit, align 4, !dbg !510, !tbaa !512
  %2 = icmp eq i32 %1, 128, !dbg !510
  br i1 %2, label %3, label %4, !dbg !510

; <label>:3                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([15 x i8]* @.str14, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([32 x i8]* @.str25, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str36, i64 0, i64 0)) #11, !dbg !516
  unreachable, !dbg !516
...
; Function Attrs: noreturn
declare void @klee_abort() #4

; Function Attrs: nounwind uwtable
define i32 @atexit(void ()* %fn) #2 {
  %1 = bitcast void ()* %fn to void (i8*)*, !dbg !525
  %2 = tail call i32 @__cxa_atexit(void (i8*)* %1, i8* null, i8* null) #9, !dbg !525
  ret i32 %2, !dbg !525
}

; Function Attrs: nounwind readonly uwtable
define i32 @atoi(i8* nocapture readonly %str) #7 {
  %1 = tail call i64 @strtol(i8* nocapture %str, i8** null, i32 10) #9, !dbg !526
...
; Function Attrs: nounwind uwtable
define i64 @klee_choose(i64 %n) #2 {
  %x = alloca i64, align 8
  %1 = bitcast i64* %x to i8*, !dbg !532
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) #9, !dbg !532
  %2 = load i64* %x, align 8, !dbg !533, !tbaa !535
  %3 = icmp ult i64 %2, %n, !dbg !533
  br i1 %3, label %5, label %4, !dbg !533

; <label>:4                                       ; preds = %0
  call void @klee_silent_exit(i32 0) #11, !dbg !537
  unreachable, !dbg !537
...
; Function Attrs: nounwind uwtable
define i8* @memcpy(i8* %destaddr, i8* nocapture readonly %srcaddr, i64 %len) #2 {
...
; Function Attrs: nounwind uwtable
define i8* @memmove(i8* %dst, i8* readonly %src, i64 %count) #2 {
...
; Function Attrs: nounwind uwtable
define i8* @mempcpy(i8* %destaddr, i8* nocapture readonly %srcaddr, i64 %len) #2 {
...
; Function Attrs: nounwind uwtable
define i8* @memset(i8* %dst, i32 %s, i64 %count) #2 {
...
; Function Attrs: nounwind uwtable
define i32 @putchar(i32 %c) #2 {
  %x = alloca i8, align 1
  %1 = trunc i32 %c to i8, !dbg !586
  store i8 %1, i8* %x, align 1, !dbg !586, !tbaa !543
  %2 = call i64 @write(i32 1, i8* %x, i64 1) #9, !dbg !587
...
; Function Attrs: nounwind uwtable
define i8* @stpcpy(i8* %to, i8* nocapture readonly %from) #2 {
...
; Function Attrs: nounwind uwtable
define i8* @strcat(i8* %s, i8* nocapture readonly %append) #2 {
  br label %1, !dbg !594
...
define i32 @strcoll(i8* nocapture readonly %s1, i8* nocapture readonly %s2) #7 {
  %1 = tail call i32 @strcmp(i8* %s1, i8* %s2) #12, !dbg !609
  ret i32 %1, !dbg !609
}

; Function Attrs: nounwind uwtable
define i8* @strcpy(i8* %to, i8* nocapture readonly %from) #2 {
...
; Function Attrs: nounwind uwtable
define i8* @strncpy(i8* %dst, i8* nocapture readonly %src, i64 %n) #2 {
...
; Function Attrs: nounwind uwtable
define i64 @strtol(i8* %nptr, i8** %endptr, i32 %base) #2 {
  %1 = tail call i16** @__ctype_b_loc() #5, !dbg !642
...
; <label>:68                                      ; preds = %66
  %69 = tail call i32* @__errno_location() #5, !dbg !691
...
; <label>:72                                      ; preds = %70, %31
  ...
  %73 = tail call i32* @__errno_location() #5, !dbg !696
...
; Function Attrs: nounwind uwtable
define i64 @strtoul(i8* %nptr, i8** %endptr, i32 %base) #2 {
  %1 = tail call i16** @__ctype_b_loc() #5, !dbg !706
...
; <label>:66                                      ; preds = %64
  %67 = tail call i32* @__errno_location() #5, !dbg !751
...
; <label>:70                                      ; preds = %68, %31
  ...
  %71 = tail call i32* @__errno_location() #5, !dbg !756
...
; Function Attrs: nounwind uwtable
define internal void @RunAtExit() #2 {
...
.lr.ph:                                           ; preds = %.lr.ph, %0
  ...
  tail call void %5(i8* %7) #9, !dbg !776
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str9, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str110, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str211, i64 0, i64 0)) #13, !dbg !780
  unreachable, !dbg !780
...
define i32 @klee_int(i8* %name) #2 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #14, !dbg !782
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str312, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str1413, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str2514, i64 0, i64 0)) #13, !dbg !786
  unreachable, !dbg !786
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #13, !dbg !791
  unreachable, !dbg !791
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #14, !dbg !794
