; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/CompressedExprLogging.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@constantArr = global [16 x i32] [i32 1, i32 2, i32 4, i32 8, i32 16, i32 32, i32 64, i32 128, i32 256, i32 512, i32 1024, i32 2048, i32 4096, i32 8192, i32 16384, i32 32768], align 16
@.str = private unnamed_addr constant [6 x i8] c"idx.0\00", align 1
@.str1 = private unnamed_addr constant [6 x i8] c"idx.1\00", align 1
@.str2 = private unnamed_addr constant [6 x i8] c"idx.2\00", align 1
@.str3 = private unnamed_addr constant [6 x i8] c"idx.3\00", align 1
@.str4 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str5 = private unnamed_addr constant [66 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/CompressedExprLogging.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0, !dbg !133
  %3 = call i32 (i8*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i64, ...)*)(i8* %2, i64 4), !dbg !133
  %4 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 1, !dbg !134
  store i8 97, i8* %4, align 1, !dbg !134
  %5 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 0, !dbg !135
  %6 = load i8* %5, align 1, !dbg !135
  %7 = sext i8 %6 to i32, !dbg !135
  %8 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 16, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0)), !dbg !135
  %9 = sext i32 %8 to i64, !dbg !135
  %10 = getelementptr inbounds [16 x i32]* @constantArr, i32 0, i64 %9, !dbg !135
  store i32 %7, i32* %10, align 4, !dbg !135
  %11 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 16, i8* getelementptr inbounds ([6 x i8]* @.str1, i32 0, i32 0)), !dbg !136
  %12 = sext i32 %11 to i64, !dbg !136
  %13 = getelementptr inbounds [16 x i32]* @constantArr, i32 0, i64 %12, !dbg !136
  %14 = load i32* %13, align 4, !dbg !136
  store i32 %14, i32* %y, align 4, !dbg !136
  %15 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 3, !dbg !137
  %16 = load i8* %15, align 1, !dbg !137
  %17 = sext i8 %16 to i32, !dbg !137
  %18 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 16, i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0)), !dbg !137
  %19 = sext i32 %18 to i64, !dbg !137
  %20 = getelementptr inbounds [16 x i32]* @constantArr, i32 0, i64 %19, !dbg !137
  store i32 %17, i32* %20, align 4, !dbg !137
  %21 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 4, i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0)), !dbg !138
  %22 = sext i32 %21 to i64, !dbg !138
  %23 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 %22, !dbg !138
  store i8 0, i8* %23, align 1, !dbg !138
  %24 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 0, !dbg !139
  %25 = load i8* %24, align 1, !dbg !139
  %26 = sext i8 %25 to i32, !dbg !139
  %27 = icmp eq i32 %26, 104, !dbg !139
  %28 = zext i1 %27 to i32, !dbg !139
  %29 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_assume to i32 (i32, ...)*)(i32 %28), !dbg !139
  %30 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0, !dbg !140
  %31 = bitcast i8* %30 to i32*, !dbg !140
  %32 = load i32* %31, align 4, !dbg !140
  store i32 %32, i32* %x, align 4, !dbg !140
  %33 = load i32* %x, align 4, !dbg !141
  %34 = icmp sgt i32 %33, 2, !dbg !141
  %35 = zext i1 %34 to i32, !dbg !141
  %36 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_assume to i32 (i32, ...)*)(i32 %35), !dbg !141
  %37 = load i32* %x, align 4, !dbg !142
  %38 = load i32* getelementptr inbounds ([16 x i32]* @constantArr, i32 0, i64 12), align 4, !dbg !142
  %39 = icmp eq i32 %37, %38, !dbg !142
  %40 = zext i1 %39 to i32, !dbg !142
  %41 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_assume to i32 (i32, ...)*)(i32 %40), !dbg !142
  %42 = load i32* %y, align 4, !dbg !143
  %43 = icmp ne i32 %42, 32, !dbg !143
  %44 = zext i1 %43 to i32, !dbg !143
  %45 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_assume to i32 (i32, ...)*)(i32 %44), !dbg !143
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([66 x i8]* @.str5, i32 0, i32 0), i32 39, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6, !dbg !144
  unreachable, !dbg !144
                                                  ; No predecessors!
  %47 = load i32* %1, !dbg !145
  ret i32 %47, !dbg !145
}
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #8, !dbg !150
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #8, !dbg !166
...
; <label>:10                                      ; preds = %6
  ...
  call void bitcast (i32 (...)* @klee_assume to void (i64)*)(i64 %12) #8, !dbg !170
  br label %19, !dbg !172

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !173
  %15 = zext i1 %14 to i64, !dbg !173
  call void bitcast (i32 (...)* @klee_assume to void (i64)*)(i64 %15) #8, !dbg !173
  %16 = load i32* %x, align 4, !dbg !175, !tbaa !152
  %17 = icmp slt i32 %16, %end, !dbg !175
  %18 = zext i1 %17 to i64, !dbg !175
  call void bitcast (i32 (...)* @klee_assume to void (i64)*)(i64 %18) #8, !dbg !175
  br label %19
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/CompressedExprLogging.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 17, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 17} ; [ DW_TAG_subprogram ] [
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/CompressedExprLogging.c]
!6 = metadata !{i32 786453, i32 0, null, metadata !"", i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !7, i32 0, null, null, null} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!7 = metadata !{metadata !8}
!8 = metadata !{i32 786468, null, null, metadata !"int", i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ] [int] [line 0, size 32, align 32, offset 0, enc DW_ATE_signed]
!9 = metadata !{metadata !10}
!10 = metadata !{i32 786484, i32 0, null, metadata !"constantArr", metadata !"constantArr", metadata !"", metadata !5, i32 13, metadata !11, i32 0, i32 1, [16 x i32]* @constantArr, null} ; [ DW_TAG_variable ] [constantArr] [line 13] [def]
!11 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 512, i64 32, i32 0, i32 0, metadata !8, metadata !12, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 512, align 32, offset 0] [from int]
!12 = metadata !{metadata !13}
!13 = metadata !{i32 786465, i64 0, i64 16}       ; [ DW_TAG_subrange_type ] [0, 15]
...
!133 = metadata !{i32 19, i32 0, metadata !4, null}
!134 = metadata !{i32 21, i32 0, metadata !4, null}
!135 = metadata !{i32 23, i32 0, metadata !4, null}
...
!145 = metadata !{i32 42, i32 0, metadata !4, null}
!146 = metadata !{i32 13, i32 0, metadata !147, null}
!147 = metadata !{i32 786443, metadata !18, metadata !17, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!148 = metadata !{i32 14, i32 0, metadata !147, null}
!149 = metadata !{i32 15, i32 0, metadata !17, null}
!150 = metadata !{i32 15, i32 0, metadata !28, null}
!151 = metadata !{i32 16, i32 0, metadata !28, null}
...
!157 = metadata !{i32 786443, metadata !43, metadata !42, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!158 = metadata !{i32 27, i32 0, metadata !159, null}
!159 = metadata !{i32 786443, metadata !43, metadata !157, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!160 = metadata !{i32 29, i32 0, metadata !42, null}
!161 = metadata !{i32 16, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !55, metadata !54, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 17, i32 0, metadata !162, null}
!164 = metadata !{i32 19, i32 0, metadata !165, null}
!165 = metadata !{i32 786443, metadata !55, metadata !54, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!166 = metadata !{i32 22, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !55, metadata !165, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!168 = metadata !{i32 25, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !55, metadata !167, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!170 = metadata !{i32 26, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !55, metadata !169, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!172 = metadata !{i32 27, i32 0, metadata !171, null}
!173 = metadata !{i32 28, i32 0, metadata !174, null}
!174 = metadata !{i32 786443, metadata !55, metadata !169, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!175 = metadata !{i32 29, i32 0, metadata !174, null}
!176 = metadata !{i32 32, i32 0, metadata !167, null}
!177 = metadata !{i32 34, i32 0, metadata !54, null}
!178 = metadata !{i32 16, i32 0, metadata !67, null}
!179 = metadata !{i32 17, i32 0, metadata !67, null}
...
!185 = metadata !{i32 18, i32 0, metadata !67, null}
!186 = metadata !{i32 16, i32 0, metadata !187, null}
!187 = metadata !{i32 786443, metadata !88, metadata !87, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!188 = metadata !{i32 19, i32 0, metadata !189, null}
!189 = metadata !{i32 786443, metadata !88, metadata !87, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!190 = metadata !{i32 20, i32 0, metadata !191, null}
!191 = metadata !{i32 786443, metadata !88, metadata !189, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!195 = metadata !{i32 786443, metadata !88, metadata !189, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!200 = metadata !{i32 28, i32 0, metadata !87, null}
!201 = metadata !{i32 15, i32 0, metadata !102, null}
!202 = metadata !{i32 16, i32 0, metadata !102, null}
!203 = metadata !{metadata !203, metadata !181, metadata !182}
!204 = metadata !{metadata !204, metadata !181, metadata !182}
!205 = metadata !{i32 17, i32 0, metadata !102, null}
!206 = metadata !{i32 13, i32 0, metadata !117, null}
!207 = metadata !{i32 14, i32 0, metadata !117, null}
!208 = metadata !{i32 15, i32 0, metadata !117, null}
