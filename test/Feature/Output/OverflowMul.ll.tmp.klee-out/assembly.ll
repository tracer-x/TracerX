; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/OverflowMul.ll.tmp1.bc'
...
define i32 @main() {
bb0:
  %v0 = extractvalue { i8, i1 } { i8 -128, i1 false }, 0
  %c0 = icmp eq i8 %v0, -128
  br i1 %c0, label %bb0_1, label %bbfalse

bb0_1:                                            ; preds = %bb0
  %o0 = extractvalue { i8, i1 } { i8 -128, i1 false }, 1
  br i1 %o0, label %bbfalse, label %bb1

bb1:                                              ; preds = %bb0_1
  %v1 = extractvalue { i8, i1 } { i8 0, i1 true }, 0
  %c1 = icmp eq i8 %v1, 0
  br i1 %c1, label %bb1_1, label %bbfalse

bb1_1:                                            ; preds = %bb1
  %o1 = extractvalue { i8, i1 } { i8 0, i1 true }, 1
  br i1 %o1, label %bbtrue, label %bbfalse

bbtrue:                                           ; preds = %bb1_1
  %0 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.passstr, i64 0, i64 0)) #4
  ret i32 0

bbfalse:                                          ; preds = %bb1_1, %bb1, %bb0_1, %bb0
  %1 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.failstr, i64 0, i64 0)) #4
  ret i32 0
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #5, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #1 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #6, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #5, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #5, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #6, !dbg !141
