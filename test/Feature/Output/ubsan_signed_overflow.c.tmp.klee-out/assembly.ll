; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/ubsan_signed_overflow.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"x\00", align 1
@.str1 = private unnamed_addr constant [2 x i8] c"y\00", align 1
@.src = private unnamed_addr constant [66 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/ubsan_signed_overflow.c\00", align 1
@0 = private unnamed_addr constant { i16, i16, [6 x i8] } { i16 0, i16 11, [6 x i8] c"'int'\00" }
@1 = private unnamed_addr global { { [66 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [66 x i8]*, i32, i32 } { [66 x i8]* @.src, i32 20, i32 14 }, { i16, i16, [6 x i8] }* @0 }
@2 = private unnamed_addr global { { [66 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [66 x i8]*, i32, i32 } { [66 x i8]* @.src, i32 23, i32 14 }, { i16, i16, [6 x i8] }* @0 }
@3 = private unnamed_addr global { { [66 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [66 x i8]*, i32, i32 } { [66 x i8]* @.src, i32 26, i32 14 }, { i16, i16, [6 x i8] }* @0 }
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast i32* %x to i8*, !dbg !128
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !dbg !128
  %3 = bitcast i32* %y to i8*, !dbg !129
  call void @klee_make_symbolic(i8* %3, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !dbg !129
  ...
  %10 = icmp sgt i64 %8, 2147483647
  %11 = or i1 %10, %9
  %12 = trunc i64 %8 to i32
  %13 = insertvalue { i32, i1 } undef, i32 %12, 0
  %14 = insertvalue { i32, i1 } %13, i1 %11, 1
  %15 = extractvalue { i32, i1 } %14, 0, !dbg !130
  %16 = extractvalue { i32, i1 } %14, 1, !dbg !130
  %17 = xor i1 %16, true, !dbg !130
  br i1 %17, label %21, label %18, !dbg !130, !prof !131

; <label>:18                                      ; preds = %0
  %19 = zext i32 %4 to i64, !dbg !130
  %20 = zext i32 %5 to i64, !dbg !130
  call void @__ubsan_handle_add_overflow(i8* bitcast ({ { [66 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @1 to i8*), i64 %19, i64 %20) #7, !dbg !130
  br label %21, !dbg !130

; <label>:21                                      ; preds = %18, %0
  store volatile i32 %15, i32* %result, align 4, !dbg !130
  %22 = load i32* %x, align 4, !dbg !132
  %23 = load i32* %y, align 4, !dbg !132
  %24 = sext i32 %22 to i64
  %25 = sext i32 %23 to i64
  %26 = sub i64 %24, %25
  %27 = icmp slt i64 %26, -2147483648
  %28 = icmp sgt i64 %26, 2147483647
  %29 = or i1 %28, %27
  %30 = trunc i64 %26 to i32
  %31 = insertvalue { i32, i1 } undef, i32 %30, 0
  %32 = insertvalue { i32, i1 } %31, i1 %29, 1
  %33 = extractvalue { i32, i1 } %32, 0, !dbg !132
  %34 = extractvalue { i32, i1 } %32, 1, !dbg !132
  %35 = xor i1 %34, true, !dbg !132
  br i1 %35, label %39, label %36, !dbg !132, !prof !131

; <label>:36                                      ; preds = %21
  %37 = zext i32 %22 to i64, !dbg !132
  %38 = zext i32 %23 to i64, !dbg !132
  call void @__ubsan_handle_sub_overflow(i8* bitcast ({ { [66 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @2 to i8*), i64 %37, i64 %38) #7, !dbg !132
  br label %39, !dbg !132

; <label>:39                                      ; preds = %36, %21
  store volatile i32 %33, i32* %result, align 4, !dbg !132
  %40 = load i32* %x, align 4, !dbg !133
  %41 = load i32* %y, align 4, !dbg !133
  %42 = sext i32 %40 to i64
  %43 = sext i32 %41 to i64
  %44 = mul i64 %42, %43
  %45 = icmp slt i64 %44, -2147483648
  %46 = icmp sgt i64 %44, 2147483647
  %47 = or i1 %46, %45
  %48 = trunc i64 %44 to i32
  %49 = insertvalue { i32, i1 } undef, i32 %48, 0
  %50 = insertvalue { i32, i1 } %49, i1 %47, 1
  %51 = extractvalue { i32, i1 } %50, 0, !dbg !133
  %52 = extractvalue { i32, i1 } %50, 1, !dbg !133
  %53 = xor i1 %52, true, !dbg !133
  br i1 %53, label %57, label %54, !dbg !133, !prof !131

; <label>:54                                      ; preds = %39
  %55 = zext i32 %40 to i64, !dbg !133
  %56 = zext i32 %41 to i64, !dbg !133
  call void @__ubsan_handle_mul_overflow(i8* bitcast ({ { [66 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @3 to i8*), i64 %55, i64 %56) #7, !dbg !133
  br label %57, !dbg !133

; <label>:57                                      ; preds = %54, %39
  store volatile i32 %51, i32* %result, align 4, !dbg !133
  ret i32 0, !dbg !134
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #8, !dbg !137
  unreachable, !dbg !137
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #9, !dbg !139
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !147
  unreachable, !dbg !147
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #8, !dbg !152
  unreachable, !dbg !152
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #9, !dbg !155
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/ubsan_signed_overflow.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 10, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 11} ; [ DW_TAG_subprogram ] [
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/ubsan_signed_overflow.c]
...
!131 = metadata !{metadata !"branch_weights", i32 1048575, i32 1}
...
!136 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!137 = metadata !{i32 14, i32 0, metadata !136, null}
!138 = metadata !{i32 15, i32 0, metadata !12, null}
!139 = metadata !{i32 15, i32 0, metadata !23, null}
!140 = metadata !{i32 16, i32 0, metadata !23, null}
...
!146 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!147 = metadata !{i32 27, i32 0, metadata !148, null}
!148 = metadata !{i32 786443, metadata !38, metadata !146, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!149 = metadata !{i32 29, i32 0, metadata !37, null}
!150 = metadata !{i32 16, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!152 = metadata !{i32 17, i32 0, metadata !151, null}
!153 = metadata !{i32 19, i32 0, metadata !154, null}
!154 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!155 = metadata !{i32 22, i32 0, metadata !156, null}
!156 = metadata !{i32 786443, metadata !50, metadata !154, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!157 = metadata !{i32 25, i32 0, metadata !158, null}
!158 = metadata !{i32 786443, metadata !50, metadata !156, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!159 = metadata !{i32 26, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !50, metadata !158, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!161 = metadata !{i32 27, i32 0, metadata !160, null}
!162 = metadata !{i32 28, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !50, metadata !158, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!164 = metadata !{i32 29, i32 0, metadata !163, null}
!165 = metadata !{i32 32, i32 0, metadata !156, null}
!166 = metadata !{i32 34, i32 0, metadata !49, null}
!167 = metadata !{i32 16, i32 0, metadata !62, null}
!168 = metadata !{i32 17, i32 0, metadata !62, null}
...
!174 = metadata !{i32 18, i32 0, metadata !62, null}
!175 = metadata !{i32 16, i32 0, metadata !176, null}
!176 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!177 = metadata !{i32 19, i32 0, metadata !178, null}
!178 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!179 = metadata !{i32 20, i32 0, metadata !180, null}
!180 = metadata !{i32 786443, metadata !83, metadata !178, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!184 = metadata !{i32 786443, metadata !83, metadata !178, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!189 = metadata !{i32 28, i32 0, metadata !82, null}
!190 = metadata !{i32 15, i32 0, metadata !97, null}
!191 = metadata !{i32 16, i32 0, metadata !97, null}
!192 = metadata !{metadata !192, metadata !170, metadata !171}
!193 = metadata !{metadata !193, metadata !170, metadata !171}
!194 = metadata !{i32 17, i32 0, metadata !97, null}
!195 = metadata !{i32 13, i32 0, metadata !112, null}
!196 = metadata !{i32 14, i32 0, metadata !112, null}
!197 = metadata !{i32 15, i32 0, metadata !112, null}
