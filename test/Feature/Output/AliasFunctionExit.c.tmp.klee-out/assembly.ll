; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/AliasFunctionExit.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [7 x i8] c"START\0A\00", align 1
@.str1 = private unnamed_addr constant [5 x i8] c"exit\00", align 1
@.str2 = private unnamed_addr constant [18 x i8] c"END: status = %d\0A\00", align 1
@.str3 = private unnamed_addr constant [2 x i8] c"x\00", align 1
@.str4 = private unnamed_addr constant [4 x i8] c"end\00", align 1
...
define void @start(i32 %x) #0 {
  %1 = alloca i32, align 4
  store i32 %x, i32* %1, align 4
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str, i32 0, i32 0))
...
define void @end(i32 %status) #3 {
  %1 = alloca i32, align 4
  store i32 %status, i32* %1, align 4
  %2 = call i32 (i8*, i8*, ...)* bitcast (i32 (...)* @klee_alias_function to i32 (i8*, i8*, ...)*)(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0))
  %3 = load i32* %1, align 4
  %4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([18 x i8]* @.str2, i32 0, i32 0), i32 %3)
...
define i32 @main() #0 {
  ...
  %1 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %x, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0))
  %2 = call i32 (i8*, i8*, ...)* bitcast (i32 (...)* @klee_alias_function to i32 (i8*, i8*, ...)*)(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0))
  %3 = load i32* %x, align 4
  call void @start(i32 %3)
  call void @end(i32 0)
  ret i32 0
}
...
attributes #3 = { noinline nounwind uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-s
