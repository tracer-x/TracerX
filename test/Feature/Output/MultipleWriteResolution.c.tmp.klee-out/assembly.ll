; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/MultipleWriteResolution.c.tmp1.bc'
...
; <label>:5                                       ; preds = %2
  ...
  %7 = add nsw i32 %6, 1
  %8 = mul nsw i32 %7, 2
  %9 = call i32* @make_int(i32 %8)
  %10 = load i32* %i, align 4
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 %11
...
; <label>:16                                      ; preds = %2
  %17 = call i32 @klee_urange(i32 0, i32 4)
  store i32 %17, i32* %s, align 4
  %18 = load i32* %s, align 4
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 %19
  %21 = load i32** %20, align 8
  store i32 5, i32* %21, align 4
  %22 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %23 = load i32** %22, align 8
  %24 = load i32* %23, align 4
  %25 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
  %26 = load i32** %25, align 8
  %27 = load i32* %26, align 4
  %28 = add nsw i32 %24, %27
  %29 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 2
  %30 = load i32** %29, align 8
  %31 = load i32* %30, align 4
  %32 = add nsw i32 %28, %31
  %33 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 3
...
; <label>:43                                      ; preds = %42, %16
  %44 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str, i32 0, i32 0))
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str1, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #8, !dbg !123
  unreachable, !dbg !123
