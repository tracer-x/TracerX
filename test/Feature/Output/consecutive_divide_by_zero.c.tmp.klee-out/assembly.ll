; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/consecutive_divide_by_zero.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"divisor1\00", align 1
@.str1 = private unnamed_addr constant [9 x i8] c"divisor2\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i32 15, i32* %a, align 4, !dbg !128
  store i32 15, i32* %b, align 4, !dbg !129
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %d1, i64 4, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0)), !dbg !130
  %3 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %d2, i64 4, i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0)), !dbg !131
  %4 = load i32* %a, align 4, !dbg !132
  %5 = load volatile i32* %d1, align 4, !dbg !132
  %int_cast_to_i64 = zext i32 %5 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !132
  %6 = udiv i32 %4, %5, !dbg !132
  store i32 %6, i32* %result1, align 4, !dbg !132
  %7 = load i32* %b, align 4, !dbg !133
  %8 = load volatile i32* %d2, align 4, !dbg !133
  %int_cast_to_i641 = zext i32 %8 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !133
  %9 = udiv i32 %7, %8, !dbg !133
  store i32 %9, i32* %result2, align 4, !dbg !133
  ret i32 0, !dbg !134
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #6, !dbg !137
  unreachable, !dbg !137
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/consecutive_divide_by_zero.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 14, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 15} ; [ DW_TAG_subprogram ] [
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/consecutive_divide_by_zero.c]
...
!130 = metadata !{i32 21, i32 0, metadata !4, null}
!131 = metadata !{i32 22, i32 0, metadata !4, null}
!132 = metadata !{i32 25, i32 0, metadata !4, null}
!133 = metadata !{i32 28, i32 0, metadata !4, null}
!134 = metadata !{i32 30, i32 0, metadata !4, null}
