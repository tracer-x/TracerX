; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/StatesCoveringNew.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 @klee_range(i32 0, i32 256, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
...
; <label>:14                                      ; preds = %10
  ...
  call void @klee_prefer_cex(i8* %15, i64 %19)
  call void @f3()
  br label %20
