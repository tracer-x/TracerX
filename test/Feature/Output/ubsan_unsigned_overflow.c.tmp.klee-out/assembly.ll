; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/ubsan_unsigned_overflow.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"x\00", align 1
@.str1 = private unnamed_addr constant [2 x i8] c"y\00", align 1
@.src = private unnamed_addr constant [68 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/ubsan_unsigned_overflow.c\00", align 1
@0 = private unnamed_addr constant { i16, i16, [15 x i8] } { i16 0, i16 10, [15 x i8] c"'unsigned int'\00" }
@1 = private unnamed_addr global { { [68 x i8]*, i32, i32 }, { i16, i16, [15 x i8] }* } { { [68 x i8]*, i32, i32 } { [68 x i8]* @.src, i32 20, i32 14 }, { i16, i16, [15 x i8] }* @0 }
@2 = private unnamed_addr global { { [68 x i8]*, i32, i32 }, { i16, i16, [15 x i8] }* } { { [68 x i8]*, i32, i32 } { [68 x i8]* @.src, i32 23, i32 14 }, { i16, i16, [15 x i8] }* @0 }
@3 = private unnamed_addr global { { [68 x i8]*, i32, i32 }, { i16, i16, [15 x i8] }* } { { [68 x i8]*, i32, i32 } { [68 x i8]* @.src, i32 26, i32 14 }, { i16, i16, [15 x i8] }* @0 }
...
define i32 @main() #0 {
  ...
  %11 = insertvalue { i32, i1 } undef, i32 %10, 0
  %12 = insertvalue { i32, i1 } %11, i1 %9, 1
  %13 = extractvalue { i32, i1 } %12, 0, !dbg !130
  %14 = extractvalue { i32, i1 } %12, 1, !dbg !130
  %15 = xor i1 %14, true, !dbg !130
  br i1 %15, label %19, label %16, !dbg !130, !prof !131

; <label>:16                                      ; preds = %0
  %17 = zext i32 %4 to i64, !dbg !130
  %18 = zext i32 %5 to i64, !dbg !130
  call void @__ubsan_handle_add_overflow(i8* bitcast ({ { [68 x i8]*, i32, i32 }, { i16, i16, [15 x i8] }* }* @1 to i8*), i64 %17, i64 %18) #7, !dbg !130
  br label %19, !dbg !130

; <label>:19                                      ; preds = %16, %0
  store volatile i32 %13, i32* %result, align 4, !dbg !130
  %20 = load i32* %x, align 4, !dbg !132
  %21 = load i32* %y, align 4, !dbg !132
  ...
  %29 = extractvalue { i32, i1 } %28, 0, !dbg !132
  %30 = extractvalue { i32, i1 } %28, 1, !dbg !132
  %31 = xor i1 %30, true, !dbg !132
  br i1 %31, label %35, label %32, !dbg !132, !prof !131

; <label>:32                                      ; preds = %19
  %33 = zext i32 %20 to i64, !dbg !132
  %34 = zext i32 %21 to i64, !dbg !132
  call void @__ubsan_handle_sub_overflow(i8* bitcast ({ { [68 x i8]*, i32, i32 }, { i16, i16, [15 x i8] }* }* @2 to i8*), i64 %33, i64 %34) #7, !dbg !132
  br label %35, !dbg !132

; <label>:35                                      ; preds = %32, %19
  store volatile i32 %29, i32* %result, align 4, !dbg !132
  %36 = load i32* %x, align 4, !dbg !133
  %37 = load i32* %y, align 4, !dbg !133
  ...
  %45 = extractvalue { i32, i1 } %44, 0, !dbg !133
  %46 = extractvalue { i32, i1 } %44, 1, !dbg !133
  %47 = xor i1 %46, true, !dbg !133
  br i1 %47, label %51, label %48, !dbg !133, !prof !131

; <label>:48                                      ; preds = %35
  %49 = zext i32 %36 to i64, !dbg !133
  %50 = zext i32 %37 to i64, !dbg !133
  call void @__ubsan_handle_mul_overflow(i8* bitcast ({ { [68 x i8]*, i32, i32 }, { i16, i16, [15 x i8] }* }* @3 to i8*), i64 %49, i64 %50) #7, !dbg !133
  br label %51, !dbg !133

; <label>:51                                      ; preds = %48, %35
  store volatile i32 %45, i32* %result, align 4, !dbg !133
  ret i32 0, !dbg !134
}
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/ubsan_unsigned_overflow.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/ubsan_unsigned_overflow.c]
