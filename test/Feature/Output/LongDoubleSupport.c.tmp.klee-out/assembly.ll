; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/LongDoubleSupport.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [20 x i8] c"counts: %d, %d, %d\0A\00", align 1
@.str1 = private unnamed_addr constant [8 x i8] c"N0 == 6\00", align 1
@.str2 = private unnamed_addr constant [62 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/LongDoubleSupport.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str3 = private unnamed_addr constant [8 x i8] c"N1 == 9\00", align 1
@.str4 = private unnamed_addr constant [9 x i8] c"N2 == 13\00", align 1
...
define i32 @main() #0 {
  ...
  %V2 = alloca x86_fp80, align 16
  store i32 0, i32* %1
  store i32 0, i32* %N0, align 4
  store i32 0, i32* %N1, align 4
  store i32 0, i32* %N2, align 4
  store float 0x3FB99999A0000000, float* %V0, align 4
  br label %2

; <label>:2                                       ; preds = %5, %0
  %3 = load float* %V0, align 4
  %4 = fcmp une float %3, 0.000000e+00
  br i1 %4, label %5, label %11

; <label>:5                                       ; preds = %2
  %6 = load float* %V0, align 4
  %7 = load float* %V0, align 4
  %8 = fmul float %7, %6
  store float %8, float* %V0, align 4
  %9 = load i32* %N0, align 4
  %10 = add i32 %9, 1
  store i32 %10, i32* %N0, align 4
  br label %2

; <label>:11                                      ; preds = %2
  store double 1.000000e-01, double* %V1, align 8
  br label %12

; <label>:12                                      ; preds = %15, %11
  %13 = load double* %V1, align 8
  %14 = fcmp une double %13, 0.000000e+00
  br i1 %14, label %15, label %21

; <label>:15                                      ; preds = %12
  %16 = load double* %V1, align 8
  %17 = load double* %V1, align 8
...
; <label>:21                                      ; preds = %12
  store x86_fp80 0xK3FFBCCCCCCCCCCCCD000, x86_fp80* %V2, align 16
  br label %22

; <label>:22                                      ; preds = %25, %21
  %23 = load x86_fp80* %V2, align 16
  %24 = fcmp une x86_fp80 %23, 0xK00000000000000000000
  br i1 %24, label %25, label %31

; <label>:25                                      ; preds = %22
  %26 = load x86_fp80* %V2, align 16
  %27 = load x86_fp80* %V2, align 16
  %28 = fmul x86_fp80 %27, %26
  store x86_fp80 %28, x86_fp80* %V2, align 16
  %29 = load i32* %N2, align 4
  %30 = add i32 %29, 1
  store i32 %30, i32* %N2, align 4
  br label %22

; <label>:31                                      ; preds = %22
  %32 = load i32* %N0, align 4
  %33 = load i32* %N1, align 4
  %34 = load i32* %N2, align 4
  %35 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([20 x i8]* @.str, i32 0, i32 0), i32 %32, i32 %33, i32 %34)
  %36 = load i32* %N0, align 4
  %37 = icmp eq i32 %36, 6
...
; <label>:39                                      ; preds = %31
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([62 x i8]* @.str2, i32 0, i32 0), i32 35, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %41
...
; <label>:45                                      ; preds = %41
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([62 x i8]* @.str2, i32 0, i32 0), i32 36, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %47
...
; <label>:51                                      ; preds = %47
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([62 x i8]* @.str2, i32 0, i32 0), i32 37, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %53
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str5, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str16, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str27, i64 0, i64 0)) #8, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #9, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str38, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #8, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #9, !dbg !141
