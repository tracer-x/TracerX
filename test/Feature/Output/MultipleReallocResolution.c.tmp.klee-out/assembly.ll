; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/MultipleReallocResolution.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [8 x i8] c"!buf[2]\00", align 1
@.str1 = private unnamed_addr constant [70 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/MultipleReallocResolution.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str2 = private unnamed_addr constant [18 x i8] c"!buf[0] && buf[1]\00", align 1
@.str3 = private unnamed_addr constant [18 x i8] c"buf[0] && !buf[1]\00", align 1
@.str4 = private unnamed_addr constant [7 x i8] c"i != 3\00", align 1
@.str5 = private unnamed_addr constant [26 x i8] c"new_size == sizeof(int)*2\00", align 1
@.str6 = private unnamed_addr constant [16 x i8] c"buf[0][0] == 10\00", align 1
@.str7 = private unnamed_addr constant [16 x i8] c"buf[0][1] == 42\00", align 1
@.str8 = private unnamed_addr constant [16 x i8] c"buf[1][0] == 20\00", align 1
...
define i32 @klee_urange(i32 %start, i32 %end) #0 {
  ...
  %3 = call i32 (i32*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, ...)*)(i32* %x, i64 4)
...
; <label>:11                                      ; preds = %0
  %12 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %13
...
declare i32 @klee_silent_exit(...) #2

; Function Attrs: nounwind uwtable
define i32* @make_int(i32 %i, i32 %N) #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
define i32 @main() #0 {
  ...
  %4 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  store i32* %3, i32** %4, align 8
  %5 = call noalias i8* @malloc(i64 4) #9
  %6 = bitcast i8* %5 to i32*
  %7 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
  store i32* %6, i32** %7, align 8
  %8 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 2
  store i32* null, i32** %8, align 8
  %9 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 3
  store i32* inttoptr (i64 3735928559 to i32*), i32** %9, align 8
  %10 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %11 = load i32** %10, align 8
  %12 = getelementptr inbounds i32* %11, i64 0
  store i32 10, i32* %12, align 4
  %13 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %14 = load i32** %13, align 8
  %15 = getelementptr inbounds i32* %14, i64 1
  store i32 42, i32* %15, align 4
  %16 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
  %17 = load i32** %16, align 8
  %18 = getelementptr inbounds i32* %17, i64 0
  store i32 20, i32* %18, align 4
  %19 = call i32 @klee_urange(i32 0, i32 4)
  store i32 %19, i32* %i, align 4
  %20 = call i32 @klee_urange(i32 0, i32 2)
  %21 = zext i32 %20 to i64
  %22 = mul i64 8, %21
  %23 = trunc i64 %22 to i32
  store i32 %23, i32* %new_size, align 4
  %24 = load i32* %i, align 4
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 %25
  %27 = load i32** %26, align 8
  %28 = bitcast i32* %27 to i8*
  %29 = load i32* %new_size, align 4
  %30 = sext i32 %29 to i64
  %31 = call i8* @realloc(i8* %28, i64 %30) #9
  %32 = bitcast i8* %31 to i32*
  %33 = load i32* %i, align 4
  %34 = sext i32 %33 to i64
  %35 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 %34
  store i32* %32, i32** %35, align 8
  %36 = load i32* %new_size, align 4
  %37 = icmp eq i32 %36, 0
  br i1 %37, label %38, label %82

; <label>:38                                      ; preds = %0
  %39 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 2
...
; <label>:43                                      ; preds = %38
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 49, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %45
...
; <label>:48                                      ; preds = %45
  %49 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %50 = load i32** %49, align 8
  %51 = icmp ne i32* %50, null
  br i1 %51, label %57, label %52

; <label>:52                                      ; preds = %48
  %53 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
...
; <label>:57                                      ; preds = %52, %48
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 50, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %59
...
; <label>:63                                      ; preds = %60
  %64 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %65 = load i32** %64, align 8
  %66 = icmp ne i32* %65, null
  br i1 %66, label %67, label %72

; <label>:67                                      ; preds = %63
  %68 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
...
; <label>:72                                      ; preds = %67, %63
  call void @__assert_fail(i8* getelementptr inbounds ([18 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 51, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %74
...
; <label>:79                                      ; preds = %75
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 52, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %81
...
; <label>:87                                      ; preds = %82
  call void @__assert_fail(i8* getelementptr inbounds ([26 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 54, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %89

; <label>:89                                      ; preds = %88, %86
  %90 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %91 = load i32** %90, align 8
  %92 = getelementptr inbounds i32* %91, i64 0
...
; <label>:96                                      ; preds = %89
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8]* @.str6, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 55, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %98

; <label>:98                                      ; preds = %97, %95
  %99 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 0
  %100 = load i32** %99, align 8
  %101 = getelementptr inbounds i32* %100, i64 1
...
; <label>:105                                     ; preds = %98
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8]* @.str7, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 56, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %107

; <label>:107                                     ; preds = %106, %104
  %108 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
  %109 = load i32** %108, align 8
  %110 = getelementptr inbounds i32* %109, i64 0
...
; <label>:114                                     ; preds = %107
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8]* @.str8, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 57, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %116
...
; <label>:119                                     ; preds = %116
  %120 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 1
  %121 = load i32** %120, align 8
  %122 = getelementptr inbounds i32* %121, i64 1
...
; <label>:127                                     ; preds = %124
  %128 = getelementptr inbounds [4 x i32*]* %buf, i32 0, i64 2
  %129 = load i32** %128, align 8
  %130 = getelementptr inbounds i32* %129, i64 0
...
; <label>:136                                     ; preds = %132
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([70 x i8]* @.str1, i32 0, i32 0), i32 60, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
                                                  ; No predecessors!
  br label %138
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str9, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str110, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str211, i64 0, i64 0)) #11, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #5 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #12, !dbg !125
  %2 = load i32* %x, align 4, !dbg !126, !tbaa !127
  ret i32 %2, !dbg !126
}

; Function Attrs: nounwind readnone
declare void @llvm.dbg.declare(metadata, metadata) #7
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str312, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #11, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str613, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #11, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #12, !dbg !141
