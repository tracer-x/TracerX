; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/CheckMemoryAccess.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [6 x i8] c"good\0A\00", align 1
@.str1 = private unnamed_addr constant [7 x i8] c"range1\00", align 1
@.str2 = private unnamed_addr constant [25 x i8] c"null pointer deref: bad\0A\00", align 1
@.str3 = private unnamed_addr constant [7 x i8] c"range2\00", align 1
@.str4 = private unnamed_addr constant [22 x i8] c"oversize access: bad\0A\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 ([4 x i8]*, i32, ...)* bitcast (i32 (...)* @klee_check_memory_access to i32 ([4 x i8]*, i32, ...)*)([4 x i8]* %buf, i32 1), !dbg !128
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0)), !dbg !129
  %4 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 2, i8* getelementptr inbounds ([7 x i8]* @.str1, i32 0, i32 0)), !dbg !130
  %5 = icmp ne i32 %4, 0, !dbg !130
  br i1 %5, label %6, label %9, !dbg !130

; <label>:6                                       ; preds = %0
  %7 = call i32 (i32, i32, ...)* bitcast (i32 (...)* @klee_check_memory_access to i32 (i32, i32, ...)*)(i32 0, i32 1), !dbg !132
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([25 x i8]* @.str2, i32 0, i32 0)), !dbg !134
  br label %9, !dbg !135

; <label>:9                                       ; preds = %6, %0
  %10 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 2, i8* getelementptr inbounds ([7 x i8]* @.str3, i32 0, i32 0)), !dbg !136
  %11 = icmp ne i32 %10, 0, !dbg !136
  br i1 %11, label %12, label %16, !dbg !136

; <label>:12                                      ; preds = %9
  %13 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0, !dbg !138
  %14 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_check_memory_access to i32 (i8*, i32, ...)*)(i8* %13, i32 5), !dbg !138
  %15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str4, i32 0, i32 0)), !dbg !140
  br label %16, !dbg !141
...
declare i32 @klee_check_memory_access(...) #2
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str5, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str16, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str27, i64 0, i64 0)) #6, !dbg !145
  unreachable, !dbg !145
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str38, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !155
  unreachable, !dbg !155
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #6, !dbg !160
  unreachable, !dbg !160
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/CheckMemoryAccess.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/CheckMemoryAccess.c]
...
!128 = metadata !{i32 14, i32 0, metadata !4, null}
!129 = metadata !{i32 15, i32 0, metadata !4, null}
!130 = metadata !{i32 16, i32 0, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !4, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/CheckMemoryAccess.c]
!132 = metadata !{i32 17, i32 0, metadata !133, null}
!133 = metadata !{i32 786443, metadata !1, metadata !131, i32 16, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/CheckMemoryAccess.c]
!134 = metadata !{i32 18, i32 0, metadata !133, null}
!135 = metadata !{i32 19, i32 0, metadata !133, null}
!136 = metadata !{i32 21, i32 0, metadata !137, null}
!137 = metadata !{i32 786443, metadata !1, metadata !4, i32 21, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/CheckMemoryAccess.c]
!138 = metadata !{i32 22, i32 0, metadata !139, null}
!139 = metadata !{i32 786443, metadata !1, metadata !137, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/CheckMemoryAccess.c]
...
!144 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!145 = metadata !{i32 14, i32 0, metadata !144, null}
!146 = metadata !{i32 15, i32 0, metadata !12, null}
!147 = metadata !{i32 15, i32 0, metadata !23, null}
!148 = metadata !{i32 16, i32 0, metadata !23, null}
...
!154 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!155 = metadata !{i32 27, i32 0, metadata !156, null}
!156 = metadata !{i32 786443, metadata !38, metadata !154, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!157 = metadata !{i32 29, i32 0, metadata !37, null}
!158 = metadata !{i32 16, i32 0, metadata !159, null}
!159 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!160 = metadata !{i32 17, i32 0, metadata !159, null}
!161 = metadata !{i32 19, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 22, i32 0, metadata !164, null}
!164 = metadata !{i32 786443, metadata !50, metadata !162, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!165 = metadata !{i32 25, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !50, metadata !164, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!167 = metadata !{i32 26, i32 0, metadata !168, null}
!168 = metadata !{i32 786443, metadata !50, metadata !166, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!169 = metadata !{i32 27, i32 0, metadata !168, null}
!170 = metadata !{i32 28, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !50, metadata !166, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
...
!175 = metadata !{i32 16, i32 0, metadata !62, null}
!176 = metadata !{i32 17, i32 0, metadata !62, null}
...
!182 = metadata !{i32 18, i32 0, metadata !62, null}
!183 = metadata !{i32 16, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!185 = metadata !{i32 19, i32 0, metadata !186, null}
!186 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!187 = metadata !{i32 20, i32 0, metadata !188, null}
!188 = metadata !{i32 786443, metadata !83, metadata !186, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!192 = metadata !{i32 786443, metadata !83, metadata !186, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!197 = metadata !{i32 28, i32 0, metadata !82, null}
!198 = metadata !{i32 15, i32 0, metadata !97, null}
!199 = metadata !{i32 16, i32 0, metadata !97, null}
!200 = metadata !{metadata !200, metadata !178, metadata !179}
!201 = metadata !{metadata !201, metadata !178, metadata !179}
!202 = metadata !{i32 17, i32 0, metadata !97, null}
!203 = metadata !{i32 13, i32 0, metadata !112, null}
!204 = metadata !{i32 14, i32 0, metadata !112, null}
!205 = metadata !{i32 15, i32 0, metadata !112, null}
