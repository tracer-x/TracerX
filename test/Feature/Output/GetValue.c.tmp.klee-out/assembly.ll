; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/GetValue.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"x\00", align 1
@.str1 = private unnamed_addr constant [41 x i8] c"!klee_is_symbolic(klee_get_value_i32(x))\00", align 1
@.str2 = private unnamed_addr constant [53 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/GetValue.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str3 = private unnamed_addr constant [27 x i8] c"klee_get_value_i32(x) > 10\00", align 1
@.str4 = private unnamed_addr constant [27 x i8] c"klee_get_value_i32(x) < 20\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i8*, ...)* bitcast (i32 (i8*)* @klee_int to i32 (i8*, ...)*)(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  store i32 %2, i32* %x, align 4
  %3 = load i32* %x, align 4
  %4 = icmp sgt i32 %3, 10
  %5 = zext i1 %4 to i32
  %6 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_assume to i32 (i32, ...)*)(i32 %5)
  %7 = load i32* %x, align 4
  %8 = icmp slt i32 %7, 20
  %9 = zext i1 %8 to i32
  %10 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_assume to i32 (i32, ...)*)(i32 %9)
  %11 = load i32* %x, align 4
  %12 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_get_value_i32 to i32 (i32, ...)*)(i32 %11)
  %13 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_is_symbolic to i32 (i32, ...)*)(i32 %12)
  %14 = icmp ne i32 %13, 0
...
; <label>:16                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([41 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8]* @.str2, i32 0, i32 0), i32 13, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %18
...
; <label>:18                                      ; preds = %17, %15
  ...
  %20 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_get_value_i32 to i32 (i32, ...)*)(i32 %19)
...
; <label>:23                                      ; preds = %18
  call void @__assert_fail(i8* getelementptr inbounds ([27 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8]* @.str2, i32 0, i32 0), i32 14, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %25
...
; <label>:25                                      ; preds = %24, %22
  ...
  %27 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_get_value_i32 to i32 (i32, ...)*)(i32 %26)
...
; <label>:30                                      ; preds = %25
  call void @__assert_fail(i8* getelementptr inbounds ([27 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8]* @.str2, i32 0, i32 0), i32 15, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %32
...
declare i32 @klee_get_value_i32(...) #1
...
; <label>:10                                      ; preds = %6
  ...
  call void bitcast (i32 (...)* @klee_assume to void (i64)*)(i64 %12) #9, !dbg !145
  br label %19, !dbg !147

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !148
  %15 = zext i1 %14 to i64, !dbg !148
  call void bitcast (i32 (...)* @klee_assume to void (i64)*)(i64 %15) #9, !dbg !148
  %16 = load i32* %x, align 4, !dbg !150, !tbaa !127
  %17 = icmp slt i32 %16, %end, !dbg !150
  %18 = zext i1 %17 to i64, !dbg !150
  call void bitcast (i32 (...)* @klee_assume to void (i64)*)(i64 %18) #9, !dbg !150
  br label %19
