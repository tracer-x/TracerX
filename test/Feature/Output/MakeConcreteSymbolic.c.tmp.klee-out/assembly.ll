; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/MakeConcreteSymbolic.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [8 x i8] c"a == 10\00", align 1
@.str1 = private unnamed_addr constant [65 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/MakeConcreteSymbolic.c\00", align 1
...
define i32 @main() #0 {
  ...
  %a = alloca i8, align 1
  store i32 0, i32* %1
  store i8 10, i8* %a, align 1, !dbg !128
  %2 = load i8* %a, align 1, !dbg !129
  %3 = sext i8 %2 to i32, !dbg !129
  %4 = icmp eq i32 %3, 10, !dbg !129
...
; <label>:6                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([65 x i8]* @.str1, i32 0, i32 0), i32 19, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6, !dbg !129
  unreachable, !dbg !129
                                                  ; No predecessors!
  br label %8, !dbg !129
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #7, !dbg !133
  unreachable, !dbg !133
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #8, !dbg !135
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !143
  unreachable, !dbg !143
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !148
  unreachable, !dbg !148
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #8, !dbg !151
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/MakeConcreteSymbolic.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/MakeConcreteSymbolic.c]
