; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/DanglingConcreteReadExpr.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [6 x i8] c"y==10\00", align 1
@.str1 = private unnamed_addr constant [69 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/DanglingConcreteReadExpr.c\00", align 1
...
; <label>:12                                      ; preds = %7
  call void @__assert_fail(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([69 x i8]* @.str1, i32 0, i32 0), i32 18, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %14
...
; <label>:15                                      ; preds = %14, %0
  %16 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  ret i32 0
}
