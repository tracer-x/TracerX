; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/FloatingPt.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"b1 == -1\00", align 1
@.str1 = private unnamed_addr constant [55 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/FloatingPt.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str2 = private unnamed_addr constant [8 x i8] c"b2 == 1\00", align 1
@.str3 = private unnamed_addr constant [9 x i8] c"a1 == -1\00", align 1
@.str4 = private unnamed_addr constant [8 x i8] c"a2 == 1\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store double -1.100000e+00, double* %a1, align 8
  store double 1.200000e+00, double* %a2, align 8
  %2 = load double* %a1, align 8
...
; <label>:7                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8]* @.str1, i32 0, i32 0), i32 12, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %9

; <label>:9                                       ; preds = %8, %6
  %10 = load double* %a2, align 8
  %11 = fptosi double %10 to i32
  store i32 %11, i32* %b2, align 4
  %12 = load i32* %b2, align 4
  %13 = icmp eq i32 %12, 1
...
; <label>:15                                      ; preds = %9
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8]* @.str1, i32 0, i32 0), i32 15, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %17

; <label>:17                                      ; preds = %16, %14
  %18 = load i32* %b1, align 4
  %19 = sitofp i32 %18 to double
  store double %19, double* %a1, align 8
  %20 = load double* %a1, align 8
...
; <label>:23                                      ; preds = %17
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8]* @.str1, i32 0, i32 0), i32 18, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %25

; <label>:25                                      ; preds = %24, %22
  %26 = load i32* %b2, align 4
  %27 = sitofp i32 %26 to double
  store double %27, double* %a2, align 8
  %28 = load double* %a2, align 8
...
; <label>:31                                      ; preds = %25
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8]* @.str1, i32 0, i32 0), i32 21, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %33
