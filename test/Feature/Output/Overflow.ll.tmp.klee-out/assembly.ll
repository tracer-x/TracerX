; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/Overflow.ll.tmp1.bc'
...
define i32 @main() {
bb0:
  %v0 = extractvalue { i8, i1 } { i8 -1, i1 false }, 0
  %c0 = icmp eq i8 %v0, -1
  br i1 %c0, label %bb0_1, label %bbfalse

bb0_1:                                            ; preds = %bb0
  %o0 = extractvalue { i8, i1 } { i8 -1, i1 false }, 1
