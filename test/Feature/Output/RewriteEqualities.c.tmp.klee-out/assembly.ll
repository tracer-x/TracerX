; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/RewriteEqualities.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"x\00", align 1
@y = common global [255 x i8] zeroinitializer, align 16
...
define i32 @run(i8* %x, i8* %y) #0 {
  ...
  %4 = load i8** %3, align 8
  %5 = getelementptr inbounds i8* %4, i64 6
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast [4 x i8]* %x to i8*
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  %3 = getelementptr inbounds [4 x i8]* %x, i32 0, i32 0
  %4 = call i32 @run(i8* %3, i8* getelementptr inbounds ([255 x i8]* @y, i32 0, i32 0))
  ret i32 %4
}
