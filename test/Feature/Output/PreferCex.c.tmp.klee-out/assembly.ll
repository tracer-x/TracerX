; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/PreferCex.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  %5 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 0
  %6 = load i8* %5, align 1
  %7 = sext i8 %6 to i32
  %8 = icmp eq i32 %7, 72
  %9 = zext i1 %8 to i32
  %10 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_prefer_cex to i32 (i8*, i32, ...)*)(i8* %4, i32 %9)
  %11 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0
  %12 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 1
  %13 = load i8* %12, align 1
  %14 = sext i8 %13 to i32
  %15 = icmp eq i32 %14, 105
  %16 = zext i1 %15 to i32
  %17 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_prefer_cex to i32 (i8*, i32, ...)*)(i8* %11, i32 %16)
  %18 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0
  %19 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 2
  %20 = load i8* %19, align 1
  %21 = sext i8 %20 to i32
  %22 = icmp eq i32 %21, 0
  %23 = zext i1 %22 to i32
  %24 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_prefer_cex to i32 (i8*, i32, ...)*)(i8* %18, i32 %23)
  %25 = getelementptr inbounds [4 x i8]* %buf, i32 0, i32 0
  %26 = getelementptr inbounds [4 x i8]* %buf, i32 0, i64 3
  %27 = load i8* %26, align 1
  %28 = sext i8 %27 to i32
  %29 = icmp eq i32 %28, 0
  %30 = zext i1 %29 to i32
  %31 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_prefer_cex to i32 (i8*, i32, ...)*)(i8* %25, i32 %30)
  ret i32 0
}

declare i32 @klee_make_symbolic(...) #1

declare i32 @klee_prefer_cex(...) #1
