; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/ReplayPath.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"res: %d\0A\00", align 1
...
define void @cond_exit() #0 {
  %1 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  ret void
}
...
; <label>:40                                      ; preds = %37, %33
  %41 = load i32* %res, align 4
  %42 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 %41)
  ret i32 0
}
