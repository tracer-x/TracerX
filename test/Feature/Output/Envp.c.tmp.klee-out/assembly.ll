; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/Envp.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [16 x i8] c"argv[argc] == 0\00", align 1
@.str1 = private unnamed_addr constant [49 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/Envp.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [32 x i8] c"int main(int, char **, char **)\00", align 1
@.str2 = private unnamed_addr constant [30 x i8] c"argc: %d, argv: %p, envp: %p\0A\00", align 1
@.str3 = private unnamed_addr constant [13 x i8] c"--environ--\0A\00", align 1
@.str4 = private unnamed_addr constant [8 x i8] c"%d: %s\0A\00", align 1
@.str5 = private unnamed_addr constant [5 x i8] c"PWD=\00", align 1
@.str6 = private unnamed_addr constant [7 x i8] c"haspwd\00", align 1
...
define i32 @main(i32 %argc, i8** %argv, i8** %envp) #0 {
  ...
  %8 = getelementptr inbounds i8** %7, i64 %6, !dbg !129
  %9 = load i8** %8, align 8, !dbg !129
  %10 = icmp eq i8* %9, null, !dbg !129
  br i1 %10, label %11, label %12, !dbg !129

; <label>:11                                      ; preds = %0
  br label %14, !dbg !129

; <label>:12                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([49 x i8]* @.str1, i32 0, i32 0), i32 9, i8* getelementptr inbounds ([32 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7, !dbg !129
  unreachable, !dbg !129
                                                  ; No predecessors!
  br label %14, !dbg !129

; <label>:14                                      ; preds = %13, %11
  %15 = load i32* %2, align 4, !dbg !130
  %16 = load i8*** %3, align 8, !dbg !130
  %17 = load i8*** %4, align 8, !dbg !130
  %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([30 x i8]* @.str2, i32 0, i32 0), i32 %15, i8** %16, i8** %17), !dbg !130
  %19 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0)), !dbg !131
  store i32 0, i32* %haspwd, align 4, !dbg !132
  store i32 0, i32* %i, align 4, !dbg !133
  br label %20, !dbg !133

; <label>:20                                      ; preds = %45, %14
  %21 = load i32* %i, align 4, !dbg !133
  %22 = zext i32 %21 to i64, !dbg !133
  %23 = load i8*** %4, align 8, !dbg !133
  %24 = getelementptr inbounds i8** %23, i64 %22, !dbg !133
  %25 = load i8** %24, align 8, !dbg !133
  %26 = icmp ne i8* %25, null, !dbg !133
  br i1 %26, label %27, label %48, !dbg !133

; <label>:27                                      ; preds = %20
  %28 = load i32* %i, align 4, !dbg !135
  %29 = load i32* %i, align 4, !dbg !135
  %30 = zext i32 %29 to i64, !dbg !135
  %31 = load i8*** %4, align 8, !dbg !135
  %32 = getelementptr inbounds i8** %31, i64 %30, !dbg !135
  %33 = load i8** %32, align 8, !dbg !135
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0), i32 %28, i8* %33), !dbg !135
  %35 = load i32* %i, align 4, !dbg !137
  %36 = zext i32 %35 to i64, !dbg !137
  %37 = load i8*** %4, align 8, !dbg !137
  %38 = getelementptr inbounds i8** %37, i64 %36, !dbg !137
  %39 = load i8** %38, align 8, !dbg !137
  %40 = call i32 @strncmp(i8* %39, i8* getelementptr inbounds ([5 x i8]* @.str5, i32 0, i32 0), i64 4), !dbg !137
  %41 = icmp eq i32 %40, 0, !dbg !137
  %42 = zext i1 %41 to i32, !dbg !137
  %43 = load i32* %haspwd, align 4, !dbg !137
  %44 = or i32 %43, %42, !dbg !137
  store i32 %44, i32* %haspwd, align 4, !dbg !137
  br label %45, !dbg !138

; <label>:45                                      ; preds = %27
  %46 = load i32* %i, align 4, !dbg !133
  %47 = add i32 %46, 1, !dbg !133
  store i32 %47, i32* %i, align 4, !dbg !133
  br label %20, !dbg !133

; <label>:48                                      ; preds = %20
  %49 = load i32* %haspwd, align 4, !dbg !139
  %50 = icmp ne i32 %49, 0, !dbg !139
  br i1 %50, label %51, label %52, !dbg !139

; <label>:51                                      ; preds = %48
  br label %54, !dbg !139

; <label>:52                                      ; preds = %48
  call void @__assert_fail(i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0), i8* getelementptr inbounds ([49 x i8]* @.str1, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([32 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7, !dbg !139
  unreachable, !dbg !139
                                                  ; No predecessors!
  br label %54, !dbg !139
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str7, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str18, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str29, i64 0, i64 0)) #8, !dbg !143
  unreachable, !dbg !143
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #9, !dbg !145
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str310, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !153
  unreachable, !dbg !153
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str611, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #8, !dbg !158
  unreachable, !dbg !158
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #9, !dbg !161
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !174
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !185
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !191
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !191
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !191
  ...
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !191
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !191
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !191
  ...
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !191
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !191
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !191
  ...
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !191
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !191
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !191
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !193
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !191
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !191
  %34 = load i8* %b.18, align 1, !dbg !191, !tbaa !178
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !191
  store i8 %34, i8* %a.17, align 1, !dbg !191, !tbaa !178
  %36 = icmp eq i64 %32, 0, !dbg !191
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !191, !llvm.loop !194
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !197
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/Envp.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 7, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i8**, i8**)* @main, null, null, metadata !2, i32 7} ; [ DW_TAG
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/Envp.c]
!6 = metadata !{i32 786453, i32 0, null, metadata !"", i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !7, i32 0, null, null, null} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!7 = metadata !{metadata !8, metadata !8, metadata !9, metadata !9}
...
!130 = metadata !{i32 10, i32 0, metadata !4, null}
!131 = metadata !{i32 11, i32 0, metadata !4, null}
!132 = metadata !{i32 12, i32 0, metadata !4, null}
!133 = metadata !{i32 13, i32 0, metadata !134, null}
!134 = metadata !{i32 786443, metadata !1, metadata !4, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/Envp.c]
!135 = metadata !{i32 14, i32 0, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !134, i32 13, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/Envp.c]
!137 = metadata !{i32 15, i32 0, metadata !136, null}
!138 = metadata !{i32 16, i32 0, metadata !136, null}
!139 = metadata !{i32 17, i32 0, metadata !4, null}
!140 = metadata !{i32 18, i32 0, metadata !4, null}
!141 = metadata !{i32 13, i32 0, metadata !142, null}
!142 = metadata !{i32 786443, metadata !16, metadata !15, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!143 = metadata !{i32 14, i32 0, metadata !142, null}
!144 = metadata !{i32 15, i32 0, metadata !15, null}
!145 = metadata !{i32 15, i32 0, metadata !26, null}
!146 = metadata !{i32 16, i32 0, metadata !26, null}
...
!152 = metadata !{i32 786443, metadata !40, metadata !39, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!153 = metadata !{i32 27, i32 0, metadata !154, null}
!154 = metadata !{i32 786443, metadata !40, metadata !152, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!155 = metadata !{i32 29, i32 0, metadata !39, null}
!156 = metadata !{i32 16, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !52, metadata !51, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!158 = metadata !{i32 17, i32 0, metadata !157, null}
!159 = metadata !{i32 19, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !52, metadata !51, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!161 = metadata !{i32 22, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !52, metadata !160, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 25, i32 0, metadata !164, null}
!164 = metadata !{i32 786443, metadata !52, metadata !162, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!165 = metadata !{i32 26, i32 0, metadata !166, null}
!166 = metadata !{i32 786443, metadata !52, metadata !164, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!167 = metadata !{i32 27, i32 0, metadata !166, null}
!168 = metadata !{i32 28, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !52, metadata !164, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!170 = metadata !{i32 29, i32 0, metadata !169, null}
!171 = metadata !{i32 32, i32 0, metadata !162, null}
!172 = metadata !{i32 34, i32 0, metadata !51, null}
!173 = metadata !{i32 16, i32 0, metadata !64, null}
!174 = metadata !{i32 17, i32 0, metadata !64, null}
...
!180 = metadata !{i32 18, i32 0, metadata !64, null}
!181 = metadata !{i32 16, i32 0, metadata !182, null}
!182 = metadata !{i32 786443, metadata !84, metadata !83, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!183 = metadata !{i32 19, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !84, metadata !83, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!185 = metadata !{i32 20, i32 0, metadata !186, null}
!186 = metadata !{i32 786443, metadata !84, metadata !184, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!190 = metadata !{i32 786443, metadata !84, metadata !184, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!195 = metadata !{i32 28, i32 0, metadata !83, null}
!196 = metadata !{i32 15, i32 0, metadata !98, null}
!197 = metadata !{i32 16, i32 0, metadata !98, null}
!198 = metadata !{metadata !198, metadata !176, metadata !177}
!199 = metadata !{metadata !199, metadata !176, metadata !177}
!200 = metadata !{i32 17, i32 0, metadata !98, null}
!201 = metadata !{i32 13, i32 0, metadata !113, null}
!202 = metadata !{i32 14, i32 0, metadata !113, null}
!203 = metadata !{i32 15, i32 0, metadata !113, null}
