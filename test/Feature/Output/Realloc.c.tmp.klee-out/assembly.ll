; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/Realloc.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"p\00", align 1
@.str1 = private unnamed_addr constant [52 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/Realloc.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str2 = private unnamed_addr constant [12 x i8] c"p2[1] == 52\00", align 1
...
; <label>:7                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8]* @.str1, i32 0, i32 0), i32 11, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %9
...
; <label>:9                                       ; preds = %8, %6
  ...
  %14 = call i8* @realloc(i8* %13, i64 1073741824) #7
  %15 = bitcast i8* %14 to i32*
  store i32* %15, i32** %p2, align 8
  %16 = load i32** %p2, align 8
...
; <label>:21                                      ; preds = %9
  call void @__assert_fail(i8* getelementptr inbounds ([12 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8]* @.str1, i32 0, i32 0), i32 16, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %23
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str3, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #9, !dbg !123
  unreachable, !dbg !123
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str36, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str147, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str258, i64 0, i64 0)) #9, !dbg !133
  unreachable, !dbg !133
