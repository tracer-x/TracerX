; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/BitcastAliasMD2U.ll.tmp1.bc'
...
entry:
  %call = call i32 bitcast (i32 (i32)* @foo to i32 (i64)*)(i64 52)
  %r = icmp eq i32 %call, 52
  br i1 %r, label %bbtrue, label %bbfalse

bbtrue:                                           ; preds = %entry
  %0 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.passstr, i64 0, i64 0)) #0
  ret i32 0

bbfalse:                                          ; preds = %entry
  %1 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.failstr, i64 0, i64 0)) #0
  ret i32 0
}
