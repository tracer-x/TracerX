; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/OneOutOfBounds.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i8* @malloc(i64 4), !dbg !128
  %3 = bitcast i8* %2 to i32*, !dbg !128
  store i32* %3, i32** %x, align 8, !dbg !128
  %4 = load i32** %x, align 8, !dbg !129
  %5 = getelementptr inbounds i32* %4, i64 1, !dbg !129
  store i32 1, i32* %5, align 4, !dbg !129
  %6 = load i32** %x, align 8, !dbg !130
  %7 = call i32 (i32*, ...)* bitcast (i32 (...)* @free to i32 (i32*, ...)*)(i32* %6), !dbg !130
  ret i32 0, !dbg !131
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #6, !dbg !134
  unreachable, !dbg !134
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #7, !dbg !136
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #7, !dbg !152
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/OneOutOfBounds.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 6, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 6} ; [ DW_TAG_subprogram ] [li
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/OneOutOfBounds.c]
...
!129 = metadata !{i32 10, i32 0, metadata !4, null}
