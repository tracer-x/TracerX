; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/Searchers.c.tmp2.bc'
...
define i32 @validate(i8* %buf, i32 %N) #0 {
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %9 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i32, ...)*)(i8* %7, i32 %8)
  %10 = load i8** %buf, align 8
  %11 = load i32* %N, align 4
  %12 = call i32 @validate(i8* %10, i32 %11)
  %13 = icmp ne i32 %12, 0
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #8, !dbg !123
  unreachable, !dbg !123
