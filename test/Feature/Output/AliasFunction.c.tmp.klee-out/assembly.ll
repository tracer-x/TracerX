; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/AliasFunction.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"  foo()\0A\00", align 1
@.str1 = private unnamed_addr constant [9 x i8] c"  bar()\0A\00", align 1
@.str2 = private unnamed_addr constant [2 x i8] c"x\00", align 1
@.str3 = private unnamed_addr constant [4 x i8] c"foo\00", align 1
@.str4 = private unnamed_addr constant [4 x i8] c"bar\00", align 1
...
define i32 @main() #2 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %x, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0))
  call void @bar()
  call void @foo()
...
; <label>:5                                       ; preds = %0
  %6 = call i32 (i8*, i8*, ...)* bitcast (i32 (...)* @klee_alias_function to i32 (i8*, i8*, ...)*)(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0))
...
; <label>:11                                      ; preds = %10, %0
  call void @foo()
  %12 = call i32 (i8*, i8*, ...)* bitcast (i32 (...)* @klee_alias_function to i32 (i8*, i8*, ...)*)(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0))
  call void @foo()
  %13 = load i32* %1
  ret i32 %13
}
...
declare i32 @klee_alias_function(...) #1
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #8, !dbg !125
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #8, !dbg !141
...
attributes #0 = { noinline nounwind uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-s
