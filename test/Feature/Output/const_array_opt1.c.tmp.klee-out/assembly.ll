; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/const_array_opt1.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"k\00", align 1
@.str1 = private unnamed_addr constant [16 x i8] c"k[i] % 256 == i\00", align 1
@.str2 = private unnamed_addr constant [61 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/const_array_opt1.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str3 = private unnamed_addr constant [24 x i8] c"Finished successfully!\0A\00", align 1
...
; <label>:5                                       ; preds = %2
  ...
  %11 = getelementptr inbounds [8192 x i8]* %a, i32 0, i64 %10
...
; <label>:15                                      ; preds = %2
  %16 = getelementptr inbounds [16 x i32]* %k, i32 0, i32 0
  %17 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %16, i64 64, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %18
...
; <label>:21                                      ; preds = %18
  ...
  %24 = getelementptr inbounds [16 x i32]* %k, i32 0, i64 %23
  %25 = load i32* %24, align 4
  %26 = icmp uge i32 %25, 8192
  br i1 %26, label %27, label %29

; <label>:27                                      ; preds = %21
  %28 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %29

; <label>:29                                      ; preds = %27, %21
  %30 = load i32* %i, align 4
  %31 = zext i32 %30 to i64
  %32 = getelementptr inbounds [16 x i32]* %k, i32 0, i64 %31
  %33 = load i32* %32, align 4
  %34 = zext i32 %33 to i64
  %35 = getelementptr inbounds [8192 x i8]* %a, i32 0, i64 %34
...
; <label>:40                                      ; preds = %29
  ...
  %43 = getelementptr inbounds [16 x i32]* %k, i32 0, i64 %42
  %44 = load i32* %43, align 4
  %int_cast_to_i641 = zext i32 256 to i64
...
; <label>:49                                      ; preds = %40
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8]* @.str2, i32 0, i32 0), i32 31, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #8
  unreachable
                                                  ; No predecessors!
  br label %51
...
; <label>:52                                      ; preds = %29
  %53 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %54
...
; <label>:58                                      ; preds = %18
  %59 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([24 x i8]* @.str3, i32 0, i32 0))
  ret i32 0
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str4, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str15, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str26, i64 0, i64 0)) #9, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #10, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str37, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #9, !dbg !133
  unreachable, !dbg !133
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #10, !dbg !141
