; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/ExternalWeakLinkage.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [13 x i8] c"IAmSoWeak==0\00", align 1
@.str1 = private unnamed_addr constant [64 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/ExternalWeakLinkage.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  br i1 icmp eq (void (i32)* @IAmSoWeak, void (i32)* null), label %2, label %3, !dbg !128

; <label>:2                                       ; preds = %0
  br label %5, !dbg !128

; <label>:3                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([64 x i8]* @.str1, i32 0, i32 0), i32 10, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7, !dbg !128
  unreachable, !dbg !128
                                                  ; No predecessors!
  br label %5, !dbg !128
...
declare extern_weak void @IAmSoWeak(i32) #1
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/Feature/ExternalWeakLinkage.c", metadata !"/home/sanghu/TracerX/tracerx/test/Feature"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/Feature//home/sanghu/TracerX/tracerx/test/Feature/ExternalWeakLinkage.c]
...
!128 = metadata !{i32 10, i32 0, metadata !4, null}
