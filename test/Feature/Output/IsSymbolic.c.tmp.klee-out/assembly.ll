; ModuleID = '/home/sanghu/TracerX/tracerx/test/Feature/Output/IsSymbolic.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [20 x i8] c"klee_is_symbolic(y)\00", align 1
@.str1 = private unnamed_addr constant [55 x i8] c"/home/sanghu/TracerX/tracerx/test/Feature/IsSymbolic.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str2 = private unnamed_addr constant [21 x i8] c"!klee_is_symbolic(z)\00", align 1
...
define i32 @main() #0 {
  ...
  %2 = call i32 (i32*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, ...)*)(i32* %x, i64 4)
  %3 = call i32 (i32*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, ...)*)(i32* %y, i64 4)
...
; <label>:6                                       ; preds = %0
  ...
  %8 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_is_symbolic to i32 (i32, ...)*)(i32 %7)
  %9 = icmp ne i32 %8, 0
...
; <label>:11                                      ; preds = %6
  call void @__assert_fail(i8* getelementptr inbounds ([20 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8]* @.str1, i32 0, i32 0), i32 12, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %13
...
; <label>:14                                      ; preds = %0
  ...
  %16 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_is_symbolic to i32 (i32, ...)*)(i32 %15)
  %17 = icmp ne i32 %16, 0
...
; <label>:19                                      ; preds = %14
  call void @__assert_fail(i8* getelementptr inbounds ([21 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8]* @.str1, i32 0, i32 0), i32 14, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %21
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str3, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #9, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str36, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str147, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str258, i64 0, i64 0)) #8, !dbg !133
  unreachable, !dbg !133
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #9, !dbg !141
