; ModuleID = 'Output/linked_ackermann.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [23 x i8] c"ackerman(%d, %d) = %d\0A\00", align 1
@.str1 = private unnamed_addr constant [3 x i8] c"%c\00", align 1
@char_format_string = global i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0), align 8
...
; <label>:15                                      ; preds = %9
  ...
  %18 = sub nsw i32 %17, 1
  %19 = call i32 @ackermann(i32 %16, i32 %18)
  br label %20

; <label>:20                                      ; preds = %15, %14
  %21 = phi i32 [ 1, %14 ], [ %19, %15 ]
  %22 = call i32 @ackermann(i32 %11, i32 %21)
  store i32 %22, i32* %1
  br label %23
...
define i32 @main() #0 {
  ...
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str, i32 0, i32 0), i32 2, i32 2, i32 %2)
  ret i32 0
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #6, !dbg !123
  unreachable, !dbg !123
