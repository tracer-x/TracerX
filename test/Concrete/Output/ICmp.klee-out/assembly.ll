; ModuleID = 'Output/linked_ICmp.bc'
...
define i32 @main() {
  ...
  %int_cast_to_i64 = zext i16 10 to i64
  call void @klee_overshift_check(i64 16, i64 %int_cast_to_i64)
  %t = shl i16 63, 10
  %sum = add i16 %sum8, %t
