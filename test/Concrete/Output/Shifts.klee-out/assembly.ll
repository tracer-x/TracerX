; ModuleID = 'Output/linked_Shifts.bc'
...
define i32 @main() {
  ...
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i64)
  %a = shl i8 1, 5
  %int_cast_to_i641 = zext i8 5 to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i641)
  %b = lshr i8 %a, 5
  %int_cast_to_i642 = zext i8 %amt to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i642)
  %c = shl i8 %b, %amt
  %int_cast_to_i643 = zext i8 %amt to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i643)
  %d = lshr i8 %c, %amt
  %int_cast_to_i644 = zext i8 7 to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i644)
  %e = shl i8 %d, 7
  %int_cast_to_i645 = zext i8 7 to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i645)
  %f = ashr i8 %e, 7
  %int_cast_to_i646 = zext i8 %amt to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i646)
  %g = shl i8 %f, %amt
  %int_cast_to_i647 = zext i8 %amt to i64
  call void @klee_overshift_check(i64 8, i64 %int_cast_to_i647)
  %h = ashr i8 %g, %amt
  %test = icmp eq i8 %h, -1
