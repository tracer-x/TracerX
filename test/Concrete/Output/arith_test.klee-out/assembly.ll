; ModuleID = 'Output/linked_arith_test.bc'
...
define void @test_cmp(i16 %op1, i16 %op2) {
  ...
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t1)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t2)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t3)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t4)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t5)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t6)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t7)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t8)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t9)
  call void bitcast (void (i8)* @print_i1 to void (i1)*)(i1 %t10)
  ret void
}

define i32 @main() {
  call void @test_simple_arith(i16 111, i16 100)
  call void @test_div_and_mod(i16 -2205, i16 3123)
  call void @test_div_and_mod(i16 1000, i16 -10092)
  call void @test_div_and_mod(i16 -16524, i16 -10092)
  call void @test_div_and_mod(i16 1000, i16 25)
  call void @test_cmp(i16 -2205, i16 3123)
  call void @test_cmp(i16 1000, i16 -10092)
  call void @test_cmp(i16 -16524, i16 -10092)
