; ModuleID = 'Output/linked_ConstantExpr.bc'
...
@gInt = global i32 10
@gIntWithConstant = global i32 sub (i32 ptrtoint (i32* @gInt to i32), i32 ptrtoint (i32* @gInt to i32))
...
define void @test_constant_ops() {
  ...
  %t4 = icmp eq i8 ptrtoint (i32* @gInt to i8), %t1
  %t5 = zext i1 %t4 to i8
...
define void @test_misc() {
  %t1 = add i32 select (i1 icmp eq (i32* inttoptr (i32 100 to i32*), i32* @gInt), i32 10, i32 0), 0
  call void @print_i32(i32 %t1)
  %t2 = load i32* getelementptr inbounds (%test.struct.type* @test_struct, i32 0, i32 1)
  call void @print_i32(i32 %t2)
  ret void
}

define void @test_simple_arith() {
  %t1 = add i32 ptrtoint (i32* @gInt to i32), 0
...
define void @test_div_and_mod() {
  ...
  %int_cast_to_i64 = zext i32 13 to i64
  ...
  %i2 = urem i32 %p, 13
  %int_cast_to_i642 = zext i32 13 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i642)
  %i3 = sdiv i32 %p, 13
  %int_cast_to_i643 = zext i32 13 to i64
