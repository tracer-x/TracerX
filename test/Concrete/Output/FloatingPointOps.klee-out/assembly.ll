; ModuleID = 'Output/linked_FloatingPointOps.bc'
...
@.strCmpTrFlt = internal constant [19 x i8] c"floats TRUE broken\00"
...
@.strCmpEqFlt = internal constant [17 x i8] c"floats == broken\00"
...
@.strCmpEqFltU = internal constant [17 x i8] c"U:floats==broken\00"
...
entry:
  ...
  %cmp_t_ok = icmp eq i1 %cmp_t, true
  ...
  %cmp_f_ok = icmp eq i1 %cmp_f, false
...
entry:
  ...
  call void @testFCmpBoth(double 0.000000e+00, double 0.000000e+00, i1 true, i1 true, i1 false, i1 true, i1 false, i1 false, i1 true, i1 false)
  call void @testFCmpBoth(double 0.000000e+00, double 1.000000e+00, i1 false, i1 false, i1 false, i1 true, i1 true, i1 true, i1 true, i1 false)
  call void @testFCmpBoth(double 1.000000e+00, double 0.000000e+00, i1 false, i1 true, i1 true, i1 false, i1 false, i1 true, i1 true, i1 false)
