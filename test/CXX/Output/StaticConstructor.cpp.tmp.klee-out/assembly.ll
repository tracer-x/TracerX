; ModuleID = '/home/sanghu/TracerX/tracerx/test/CXX/Output/StaticConstructor.cpp.tmp1.bc'
...
@aGlobal = global i32 21, align 4
@t = global %class.Test zeroinitializer, align 4
@__dso_handle = external global i8
@.str = private unnamed_addr constant [13 x i8] c"t.getX()==22\00", align 1
@.str1 = private unnamed_addr constant [60 x i8] c"/home/sanghu/TracerX/tracerx/test/CXX/StaticConstructor.cpp\00", align 1
...
define internal void @__cxx_global_var_init() section ".text.startup" {
  call void @_ZN4TestC2Ev(%class.Test* @t)
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%class.Test*)* @_ZN4TestD2Ev to void (i8*)*), i8* bitcast (%class.Test* @t to i8*), i8* @__dso_handle) #10
  ret void
}
...
define i32 @main() #1 {
  ...
  store i32 0, i32* %1
  %2 = call i32 @_ZN4Test4getXEv(%class.Test* @t)
  %3 = icmp eq i32 %2, 22
...
; <label>:5                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([60 x i8]* @.str1, i32 0, i32 0), i32 23, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #12
  unreachable
                                                  ; No predecessors!
  br label %7
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32 @_ZN4Test4getXEv(%class.Test* %this) #0 align 2 {
  %1 = alloca %class.Test*, align 8
  store %class.Test* %this, %class.Test** %1, align 8
  %2 = load %class.Test** %1
  %3 = getelementptr inbounds %class.Test* %2, i32 0, i32 0
...
define i64 @klee_choose(i64 %n) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) #10, !dbg !532
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str7, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str18, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str29, i64 0, i64 0)) #14, !dbg !780
  unreachable, !dbg !780
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #15, !dbg !782
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str310, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #14, !dbg !786
  unreachable, !dbg !786
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #15, !dbg !794
