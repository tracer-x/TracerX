; ModuleID = '/home/sanghu/TracerX/tracerx/test/CXX/Output/Trivial.cpp.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.Test = type { i32 }

@.str = private unnamed_addr constant [13 x i8] c"rt.getX()==2\00", align 1
@.str1 = private unnamed_addr constant [50 x i8] c"/home/sanghu/TracerX/tracerx/test/CXX/Trivial.cpp\00", align 1
...
define i32 @main() #0 {
  ...
  %rt = alloca %class.Test, align 4
  %2 = alloca i8*
  %3 = alloca i32
  %4 = alloca i32
  store i32 0, i32* %1
  call void @_ZN4TestC2Ei(%class.Test* %rt, i32 2)
  %5 = invoke i32 @_ZN4Test4getXEv(%class.Test* %rt)
...
; <label>:9                                       ; preds = %6
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([50 x i8]* @.str1, i32 0, i32 0), i32 20, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #8
  unreachable
...
; <label>:10                                      ; preds = %0
  ...
  store i32 %13, i32* %3
  invoke void @_ZN4TestD2Ev(%class.Test* %rt)
...
; <label>:15                                      ; preds = %14, %8
  store i32 0, i32* %1
  store i32 1, i32* %4
  call void @_ZN4TestD2Ev(%class.Test* %rt)
  %16 = load i32* %1
  ret i32 %16
...
define linkonce_odr void @_ZN4TestC2Ei(%class.Test* %this, i32 %_x) unnamed_addr #1 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32 @_ZN4Test4getXEv(%class.Test* %this) #1 align 2 {
  %1 = alloca %class.Test*, align 8
  store %class.Test* %this, %class.Test** %1, align 8
  %2 = load %class.Test** %1
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN4TestD2Ev(%class.Test* %this) unnamed_addr #1 align 2 {
  %1 = alloca %class.Test*, align 8
  store %class.Test* %this, %class.Test** %1, align 8
  %2 = load %class.Test** %1
  ret void
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #11, !dbg !125
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #11, !dbg !141
