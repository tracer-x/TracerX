; ModuleID = '/home/sanghu/TracerX/tracerx/test/CXX/Output/ArrayNew.cpp.tmp1.bc'
...
@.str1 = private unnamed_addr constant [51 x i8] c"/home/sanghu/TracerX/tracerx/test/CXX/ArrayNew.cpp\00", align 1
...
@.str2 = private unnamed_addr constant [10 x i8] c"decon==10\00", align 1
...
define i32 @main(i32 %argc) #0 {
  ...
  %5 = call noalias i8* @_Znam(i64 24) #10
  %6 = bitcast i8* %5 to i64*
  store i64 4, i64* %6
  %7 = getelementptr inbounds i8* %5, i64 8
  %8 = bitcast i8* %7 to %class.Test*
  %9 = getelementptr inbounds %class.Test* %8, i64 4
  br label %10

; <label>:10                                      ; preds = %12, %0
  %11 = phi %class.Test* [ %8, %0 ], [ %13, %12 ]
  invoke void @_ZN4TestC2Ev(%class.Test* %11)
          to label %12 unwind label %29

; <label>:12                                      ; preds = %10
  %13 = getelementptr inbounds %class.Test* %11, i64 1
  %14 = icmp eq %class.Test* %13, %9
  br i1 %14, label %15, label %10

; <label>:15                                      ; preds = %12
  store %class.Test* %8, %class.Test** %rt, align 8
...
; <label>:19                                      ; preds = %16
  ...
  %22 = load %class.Test** %rt, align 8
  %23 = getelementptr inbounds %class.Test* %22, i64 %21
  %24 = load i32* %i, align 4
  %25 = add nsw i32 %24, 1
  call void @_ZN4Test4setXEi(%class.Test* %23, i32 %25)
  br label %26
...
; <label>:29                                      ; preds = %10
  ...
  store i32 %32, i32* %4
  %33 = icmp eq %class.Test* %8, %11
  br i1 %33, label %39, label %34

; <label>:34                                      ; preds = %37, %29
  %35 = phi %class.Test* [ %11, %29 ], [ %36, %37 ]
  %36 = getelementptr inbounds %class.Test* %35, i64 -1
  invoke void @_ZN4TestD2Ev(%class.Test* %36)
          to label %37 unwind label %100

; <label>:37                                      ; preds = %34
  %38 = icmp eq %class.Test* %36, %8
...
; <label>:44                                      ; preds = %41
  ...
  %47 = load %class.Test** %rt, align 8
  %48 = getelementptr inbounds %class.Test* %47, i64 %46
  %49 = call i32 @_ZN4Test4getXEv(%class.Test* %48)
  %50 = load i32* %sum, align 4
...
; <label>:59                                      ; preds = %55
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([51 x i8]* @.str1, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #12
  unreachable
                                                  ; No predecessors!
  br label %61

; <label>:61                                      ; preds = %60, %58
  %62 = load %class.Test** %rt, align 8
  %63 = icmp eq %class.Test* %62, null
  br i1 %63, label %77, label %64

; <label>:64                                      ; preds = %61
  %65 = bitcast %class.Test* %62 to i8*
  %66 = getelementptr inbounds i8* %65, i64 -8
  %67 = bitcast i8* %66 to i64*
  %68 = load i64* %67
  %69 = getelementptr inbounds %class.Test* %62, i64 %68
  %70 = icmp eq %class.Test* %62, %69
  br i1 %70, label %76, label %71

; <label>:71                                      ; preds = %74, %64
  %72 = phi %class.Test* [ %69, %64 ], [ %73, %74 ]
  %73 = getelementptr inbounds %class.Test* %72, i64 -1
  invoke void @_ZN4TestD2Ev(%class.Test* %73)
          to label %74 unwind label %82

; <label>:74                                      ; preds = %71
  %75 = icmp eq %class.Test* %73, %62
...
; <label>:81                                      ; preds = %77
  call void @__assert_fail(i8* getelementptr inbounds ([10 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([51 x i8]* @.str1, i32 0, i32 0), i32 36, i8* getelementptr inbounds ([14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #12
  unreachable
...
; <label>:82                                      ; preds = %71
  ...
  store i32 %85, i32* %4
  %86 = icmp eq %class.Test* %62, %73
  br i1 %86, label %92, label %87

; <label>:87                                      ; preds = %90, %82
  %88 = phi %class.Test* [ %73, %82 ], [ %89, %90 ]
  %89 = getelementptr inbounds %class.Test* %88, i64 -1
  invoke void @_ZN4TestD2Ev(%class.Test* %89)
          to label %90 unwind label %100

; <label>:90                                      ; preds = %87
  %91 = icmp eq %class.Test* %89, %62
...
define linkonce_odr void @_ZN4TestC2Ev(%class.Test* %this) unnamed_addr #2 align 2 {
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN4TestD2Ev(%class.Test* %this) unnamed_addr #2 align 2 {
  %1 = alloca %class.Test*, align 8
  store %class.Test* %this, %class.Test** %1, align 8
  %2 = load %class.Test** %1
  %3 = getelementptr inbounds %class.Test* %2, i32 0, i32 0
  %4 = load i32* %3, align 4
  %5 = load i32* @_ZL5decon, align 4
  %6 = add nsw i32 %5, %4
  store i32 %6, i32* @_ZL5decon, align 4
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZN4Test4setXEi(%class.Test* %this, i32 %_x) #2 align 2 {
  %1 = alloca %class.Test*, align 8
  %2 = alloca i32, align 4
  store %class.Test* %this, %class.Test** %1, align 8
  ...
  %5 = getelementptr inbounds %class.Test* %3, i32 0, i32 0
  store i32 %4, i32* %5, align 4
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr i32 @_ZN4Test4getXEv(%class.Test* %this) #2 align 2 {
  %1 = alloca %class.Test*, align 8
  store %class.Test* %this, %class.Test** %1, align 8
  %2 = load %class.Test** %1
  %3 = getelementptr inbounds %class.Test* %2, i32 0, i32 0
...
attributes #4 = { nobuiltin nounwind "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-flo
