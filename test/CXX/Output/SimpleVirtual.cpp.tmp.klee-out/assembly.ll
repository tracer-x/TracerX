; ModuleID = '/home/sanghu/TracerX/tracerx/test/CXX/Output/SimpleVirtual.cpp.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.Thing = type { i32 (...)** }
%class.Thing2 = type { %class.Thing }

@.str = private unnamed_addr constant [5 x i8] c"x==3\00", align 1
@.str1 = private unnamed_addr constant [56 x i8] c"/home/sanghu/TracerX/tracerx/test/CXX/SimpleVirtual.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [14 x i8] c"int main(int)\00", align 1
@_ZL5decon = internal global i32 0, align 4
@.str2 = private unnamed_addr constant [9 x i8] c"decon==2\00", align 1
@_ZTV6Thing2 = linkonce_odr unnamed_addr constant [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI6Thing2 to i8*), i8* bitcast (void (%class.Thing2*)* @_ZN6Thing2D2Ev to i8*), i8* bitcast (void (%class.Thing2*)* @_ZN6Thing2D0Ev to i8*), i8* bit
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS6Thing2 = linkonce_odr constant [8 x i8] c"6Thing2\00"
@_ZTVN10__cxxabiv117__class_type_infoE = external global i8*
@_ZTS5Thing = linkonce_odr constant [7 x i8] c"5Thing\00"
@_ZTI5Thing = linkonce_odr unnamed_addr constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([7 x i8]* @_ZTS5Thing, i32 0, i32 0) }
@_ZTI6Thing2 = linkonce_odr unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([8 x i8]* @_ZTS6Thing2, i32 0, i32 0), i8* bitcast
@_ZTV5Thing = linkonce_odr unnamed_addr constant [5 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI5Thing to i8*), i8* bitcast (void (%class.Thing*)* @_ZN5ThingD2Ev to i8*), i8* bitcast (void (%class.Thing*)* @_ZN5ThingD0Ev to i8*), i8* bitcast (i32 (
...
define %class.Thing* @_Z8getThingb(i1 zeroext %which) #0 {
  %1 = alloca i8, align 1
  %2 = alloca i8*
  %3 = alloca i1
  %4 = alloca i8*
...
; <label>:11                                      ; preds = %0
  %12 = call noalias i8* @_Znwm(i64 8) #11
  store i8* %12, i8** %2
  store i1 true, i1* %3
  %13 = bitcast i8* %12 to %class.Thing*
  invoke void @_ZN5ThingC2Ev(%class.Thing* %13)
...
; <label>:15                                      ; preds = %0
  %16 = call noalias i8* @_Znwm(i64 8) #11
  store i8* %16, i8** %6
  store i1 true, i1* %7
  %17 = bitcast i8* %16 to %class.Thing2*
  %18 = bitcast %class.Thing2* %17 to i8*
  %19 = call i8* @memset(i8* %18, i32 0, i64 8)
  invoke void @_ZN6Thing2C2Ev(%class.Thing2* %17)
          to label %20 unwind label %32

; <label>:20                                      ; preds = %15
  %21 = bitcast %class.Thing2* %17 to %class.Thing*
  br label %22

; <label>:22                                      ; preds = %20, %14
  %23 = phi %class.Thing* [ %13, %14 ], [ %21, %20 ]
  ret %class.Thing* %23
...
define linkonce_odr void @_ZN5ThingC2Ev(%class.Thing* %this) unnamed_addr #2 align 2 {
  %1 = alloca %class.Thing*, align 8
  store %class.Thing* %this, %class.Thing** %1, align 8
  %2 = load %class.Thing** %1
  %3 = bitcast %class.Thing* %2 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV5Thing, i64 0, i64 2), i8*** %3
  ret void
}
...
define linkonce_odr void @_ZN6Thing2C2Ev(%class.Thing2* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.Thing2*, align 8
  store %class.Thing2* %this, %class.Thing2** %1, align 8
  %2 = load %class.Thing2** %1
  %3 = bitcast %class.Thing2* %2 to %class.Thing*
  call void @_ZN5ThingC2Ev(%class.Thing* %3)
  %4 = bitcast %class.Thing2* %2 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV6Thing2, i64 0, i64 2), i8*** %4
  ret void
}
...
define i32 @main(i32 %argc) #0 {
  ...
  %one = alloca %class.Thing*, align 8
  %two = alloca %class.Thing*, align 8
  %x = alloca i32, align 4
  store i32 0, i32* %1
  store i32 %argc, i32* %2, align 4
  %3 = call %class.Thing* @_Z8getThingb(i1 zeroext false)
  store %class.Thing* %3, %class.Thing** %one, align 8
  %4 = call %class.Thing* @_Z8getThingb(i1 zeroext true)
  store %class.Thing* %4, %class.Thing** %two, align 8
  %5 = load %class.Thing** %one, align 8
  %6 = bitcast %class.Thing* %5 to i32 (%class.Thing*)***
  %7 = load i32 (%class.Thing*)*** %6
  %8 = getelementptr inbounds i32 (%class.Thing*)** %7, i64 2
  %9 = load i32 (%class.Thing*)** %8
  %10 = call i32 %9(%class.Thing* %5)
  %11 = load %class.Thing** %two, align 8
  %12 = bitcast %class.Thing* %11 to i32 (%class.Thing*)***
  %13 = load i32 (%class.Thing*)*** %12
  %14 = getelementptr inbounds i32 (%class.Thing*)** %13, i64 2
  %15 = load i32 (%class.Thing*)** %14
  %16 = call i32 %15(%class.Thing* %11)
...
; <label>:21                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([56 x i8]* @.str1, i32 0, i32 0), i32 31, i8* getelementptr inbounds ([14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #13
  unreachable
                                                  ; No predecessors!
  br label %23

; <label>:23                                      ; preds = %22, %20
  %24 = load %class.Thing** %two, align 8
  %25 = icmp eq %class.Thing* %24, null
  br i1 %25, label %31, label %26

; <label>:26                                      ; preds = %23
  %27 = bitcast %class.Thing* %24 to void (%class.Thing*)***
  %28 = load void (%class.Thing*)*** %27
  %29 = getelementptr inbounds void (%class.Thing*)** %28, i64 1
  %30 = load void (%class.Thing*)** %29
  call void %30(%class.Thing* %24)
  br label %31

; <label>:31                                      ; preds = %26, %23
  %32 = load %class.Thing** %one, align 8
  %33 = icmp eq %class.Thing* %32, null
  br i1 %33, label %39, label %34

; <label>:34                                      ; preds = %31
  %35 = bitcast %class.Thing* %32 to void (%class.Thing*)***
  %36 = load void (%class.Thing*)*** %35
  %37 = getelementptr inbounds void (%class.Thing*)** %36, i64 1
  %38 = load void (%class.Thing*)** %37
  call void %38(%class.Thing* %32)
  br label %39

; <label>:39                                      ; preds = %34, %31
  %40 = load i32* @_ZL5decon, align 4
  %41 = icmp eq i32 %40, 2
...
; <label>:43                                      ; preds = %39
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([56 x i8]* @.str1, i32 0, i32 0), i32 36, i8* getelementptr inbounds ([14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #13
  unreachable
                                                  ; No predecessors!
  br label %45
...
; Function Attrs: inlinehint uwtable
define linkonce_odr void @_ZN6Thing2D2Ev(%class.Thing2* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.Thing2*, align 8
  store %class.Thing2* %this, %class.Thing2** %1, align 8
  %2 = load %class.Thing2** %1
  %3 = bitcast %class.Thing2* %2 to %class.Thing*
  call void @_ZN5ThingD2Ev(%class.Thing* %3)
  ret void
}

; Function Attrs: inlinehint uwtable
define linkonce_odr void @_ZN6Thing2D0Ev(%class.Thing2* %this) unnamed_addr #5 align 2 {
  %1 = alloca %class.Thing2*, align 8
  %2 = alloca i8*
  %3 = alloca i32
  store %class.Thing2* %this, %class.Thing2** %1, align 8
  %4 = load %class.Thing2** %1
  invoke void @_ZN6Thing2D2Ev(%class.Thing2* %4)
          to label %5 unwind label %7

; <label>:5                                       ; preds = %0
  %6 = bitcast %class.Thing2* %4 to i8*
...
; <label>:7                                       ; preds = %0
  ...
  store i32 %10, i32* %3
  %11 = bitcast %class.Thing2* %4 to i8*
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32 @_ZN6Thing24getXEv(%class.Thing2* %this) unnamed_addr #2 align 2 {
  %1 = alloca %class.Thing2*, align 8
  store %class.Thing2* %this, %class.Thing2** %1, align 8
  %2 = load %class.Thing2** %1
  ret i32 2
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN5ThingD2Ev(%class.Thing* %this) unnamed_addr #0 align 2 {
  %1 = alloca %class.Thing*, align 8
  store %class.Thing* %this, %class.Thing** %1, align 8
  %2 = load %class.Thing** %1
  %3 = bitcast %class.Thing* %2 to i8***
  store i8** getelementptr inbounds ([5 x i8*]* @_ZTV5Thing, i64 0, i64 2), i8*** %3
  %4 = bitcast %class.Thing* %2 to i32 (%class.Thing*)***
  %5 = load i32 (%class.Thing*)*** %4
  %6 = getelementptr inbounds i32 (%class.Thing*)** %5, i64 2
  %7 = load i32 (%class.Thing*)** %6
  %8 = call i32 %7(%class.Thing* %2)
  %9 = load i32* @_ZL5decon, align 4
  %10 = add nsw i32 %9, %8
  store i32 %10, i32* @_ZL5decon, align 4
  ret void
}

; Function Attrs: uwtable
define linkonce_odr void @_ZN5ThingD0Ev(%class.Thing* %this) unnamed_addr #0 align 2 {
  %1 = alloca %class.Thing*, align 8
  %2 = alloca i8*
  %3 = alloca i32
  store %class.Thing* %this, %class.Thing** %1, align 8
  %4 = load %class.Thing** %1
  invoke void @_ZN5ThingD2Ev(%class.Thing* %4)
          to label %5 unwind label %7

; <label>:5                                       ; preds = %0
  %6 = bitcast %class.Thing* %4 to i8*
  call void @_ZdlPv(i8* %6) #12
  ret void
...
; <label>:7                                       ; preds = %0
  ...
  %10 = extractvalue { i8*, i32 } %8, 1
  store i32 %10, i32* %3
  %11 = bitcast %class.Thing* %4 to i8*
  call void @_ZdlPv(i8* %11) #12
  br label %12
...
; Function Attrs: nounwind uwtable
define linkonce_odr i32 @_ZN5Thing4getXEv(%class.Thing* %this) unnamed_addr #2 align 2 {
  %1 = alloca %class.Thing*, align 8
  store %class.Thing* %this, %class.Thing** %1, align 8
  %2 = load %class.Thing** %1
  ret i32 1
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str3, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #14, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #7 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #15, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str36, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str147, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str258, i64 0, i64 0)) #14, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #14, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #15, !dbg !141
...
attributes #1 = { nobuiltin "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-float"="fals
...
attributes #3 = { nobuiltin nounwind "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-flo
attributes #4 = { nounwind }
attributes #5 = { inlinehint uwtable "less-precise-fpmad"="false" "no-frame-pointer-elim"="true" "no-frame-pointer-elim-non-leaf" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "stack-protector-buffer-size"="8" "unsafe-fp-math"="false" "use-soft-flo
