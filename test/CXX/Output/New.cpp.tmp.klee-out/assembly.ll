; ModuleID = '/home/sanghu/TracerX/tracerx/test/CXX/Output/New.cpp.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%class.Test = type { i32 }

@.str = private unnamed_addr constant [14 x i8] c"rt->getX()==2\00", align 1
@.str1 = private unnamed_addr constant [46 x i8] c"/home/sanghu/TracerX/tracerx/test/CXX/New.cpp\00", align 1
...
define i32 @main(i32 %argc) #0 {
  ...
  %5 = call noalias i8* @_Znwm(i64 4) #9
  %6 = bitcast i8* %5 to %class.Test*
  invoke void @_ZN4TestC2Ei(%class.Test* %6, i32 2)
          to label %7 unwind label %13

; <label>:7                                       ; preds = %0
  store %class.Test* %6, %class.Test** %rt, align 8
  %8 = load %class.Test** %rt, align 8
  %9 = call i32 @_ZN4Test4getXEv(%class.Test* %8)
  %10 = icmp eq i32 %9, 2
...
; <label>:12                                      ; preds = %7
  call void @__assert_fail(i8* getelementptr inbounds ([14 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([46 x i8]* @.str1, i32 0, i32 0), i32 25, i8* getelementptr inbounds ([14 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #10
  unreachable
...
; <label>:18                                      ; preds = %17, %11
  %19 = load %class.Test** %rt, align 8
  %20 = icmp eq %class.Test* %19, null
  br i1 %20, label %24, label %21

; <label>:21                                      ; preds = %18
  invoke void @_ZN4TestD2Ev(%class.Test* %19)
          to label %22 unwind label %25

; <label>:22                                      ; preds = %21
  %23 = bitcast %class.Test* %19 to i8*
...
; <label>:25                                      ; preds = %21
  ...
  store i32 %28, i32* %4
  %29 = bitcast %class.Test* %19 to i8*
...
define linkonce_odr void @_ZN4TestC2Ei(%class.Test* %this, i32 %_x) unnamed_addr #2 align 2 {
  %1 = alloca %class.Test*, align 8
  %2 = alloca i32, align 4
  store %class.Test* %this, %class.Test** %1, align 8
  store i32 %_x, i32* %2, align 4
  %3 = load %class.Test** %1
  %4 = getelementptr inbounds %class.Test* %3, i32 0, i32 0
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #12, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #5 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #13, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #12, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #12, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #13, !dbg !141
