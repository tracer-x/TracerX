; ModuleID = '/home/sanghu/TracerX/tracerx/test/Runtime/POSIX/Output/FilePerm.c.tmp.bc'
...
@.str1 = private unnamed_addr constant [30 x i8] c"File 'A' opened successfully\0A\00", align 1
@.str2 = private unnamed_addr constant [22 x i8] c"Cannot open file 'A'\0A\00", align 1
...
@.str113 = private unnamed_addr constant [33 x i8] c"symbolic file, ignoring (EINVAL)\00", align 1
...
@.str224 = private unnamed_addr constant [17 x i8] c"ignoring (EPERM)\00", align 1
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = call i32 (i8*, i32, ...)* @open(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i32 2)
...
; <label>:7                                       ; preds = %0
  ...
  %9 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([30 x i8]* @.str1, i32 0, i32 0))
  br label %13

; <label>:10                                      ; preds = %0
  %11 = load %struct._IO_FILE** @stderr, align 8
  %12 = call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([22 x i8]* @.str2, i32 0, i32 0))
  br label %13

; <label>:13                                      ; preds = %10, %7
  %14 = load i32* %fd, align 4
  %15 = icmp ne i32 %14, -1
  br i1 %15, label %16, label %19

; <label>:16                                      ; preds = %13
  %17 = load i32* %fd, align 4
  %18 = call i32 (i32, ...)* bitcast (i32 (i32)* @close to i32 (i32, ...)*)(i32 %17)
  br label %19
...
; <label>:15                                      ; preds = %11
  tail call void @klee_warning(i8* getelementptr inbounds ([33 x i8]* @.str113, i64 0, i64 0)) #7, !dbg !3024
...
; <label>:128                                     ; preds = %32
  call void @klee_warning(i8* getelementptr inbounds ([33 x i8]* @.str113, i64 0, i64 0)) #7, !dbg !3190
...
; <label>:44                                      ; preds = %34
  call void @klee_warning(i8* getelementptr inbounds ([33 x i8]* @.str113, i64 0, i64 0)) #7, !dbg !3224
...
__get_sym_file.exit.thread:                       ; preds = %16, %10, %.preheader.i, %4, %0
  tail call void @klee_warning(i8* getelementptr inbounds ([17 x i8]* @.str224, i64 0, i64 0)) #7, !dbg !3363
...
__get_sym_file.exit.thread:                       ; preds = %16, %10, %.preheader.i, %4, %0
  tail call void @klee_warning(i8* getelementptr inbounds ([17 x i8]* @.str224, i64 0, i64 0)) #7, !dbg !3390
...
__get_sym_file.exit.thread:                       ; preds = %16, %10, %.preheader.i, %4, %0
  tail call void @klee_warning(i8* getelementptr inbounds ([17 x i8]* @.str224, i64 0, i64 0)) #7, !dbg !3417
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str33, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str134, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str235, i64 0, i64 0)) #17, !dbg !4191
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str336, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str1437, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str2538, i64 0, i64 0)) #17, !dbg !4197
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str639, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str1740, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #17, !dbg !4202
