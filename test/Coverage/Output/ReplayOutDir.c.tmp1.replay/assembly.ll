; ModuleID = '/home/sanghu/TracerX/tracerx/test/Coverage/Output/ReplayOutDir.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %i, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  %3 = load i32* %i, align 4
  %4 = call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_print_range to i32 (i8*, i32, ...)*)(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i32 %3)
  ret i32 0
}

declare i32 @klee_make_symbolic(...) #1

declare i32 @klee_print_range(...) #1
