; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2012-05-13-asm-causes-aborts.c.tmp1.bc'
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void asm sideeffect "movl %eax, %eax", "~{dirflag},~{fpsr},~{flags}"() #5, !srcloc !121
  ret i32 0
}

; Function Attrs: nounwind uwtable
define void @klee_div_zero_check(i64 %z) #1 {
  %1 = icmp eq i64 %z, 0, !dbg !122
  br i1 %1, label %2, label %3, !dbg !122

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #6, !dbg !124
  unreachable, !dbg !124
...
define i32 @klee_int(i8* %name) #1 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !126
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #7, !dbg !126
  %2 = load i32* %x, align 4, !dbg !127, !tbaa !128
  ret i32 %2, !dbg !127
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !134
  unreachable, !dbg !134
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #6, !dbg !139
  unreachable, !dbg !139
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #7, !dbg !142
  %8 = icmp eq i32 %start, 0, !dbg !144
  %9 = load i32* %x, align 4, !dbg !146, !tbaa !128
  br i1 %8, label %10, label %13, !dbg !144

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !146
  %12 = zext i1 %11 to i64, !dbg !146
  call void @klee_assume(i64 %12) #7, !dbg !146
  br label %19, !dbg !148

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !149
  %15 = zext i1 %14 to i64, !dbg !149
  call void @klee_assume(i64 %15) #7, !dbg !149
  %16 = load i32* %x, align 4, !dbg !151, !tbaa !128
  %17 = icmp slt i32 %16, %end, !dbg !151
  %18 = zext i1 %17 to i64, !dbg !151
  call void @klee_assume(i64 %18) #7, !dbg !151
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !152, !tbaa !128
  br label %21, !dbg !152
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !155, !tbaa !159
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !155
  store i8 %12, i8* %dest.02, align 1, !dbg !155, !tbaa !159
  %14 = icmp eq i64 %10, 0, !dbg !154
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !154, !llvm.loop !160

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !161
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #1 {
  %1 = icmp eq i8* %src, %dst, !dbg !162
  br i1 %1, label %.loopexit, label %2, !dbg !162

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !164
  br i1 %3, label %.preheader, label %18, !dbg !164

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !166
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !166
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !166
  %wide.load = load <16 x i8>* %6, align 1, !dbg !166
  %next.gep.sum586 = or i64 %index, 16, !dbg !166
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !166
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !166
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !166
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !166
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !166
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !166
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !166
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !166
  %index.next = add i64 %index, 32
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !166
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !166
  %15 = load i8* %b.04, align 1, !dbg !166, !tbaa !159
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !166
  store i8 %15, i8* %a.03, align 1, !dbg !166, !tbaa !159
  %17 = icmp eq i64 %13, 0, !dbg !166
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !166, !llvm.loop !169

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !170
  %20 = icmp eq i64 %count, 0, !dbg !172
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !172

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !173
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !170
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !172
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !172
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !172
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !172
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !172
  %.sum505 = add i64 %.sum440, -31, !dbg !172
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !172
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !172
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !172
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !172
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !172
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !172
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !172
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !172
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !172
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !172
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !172
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !172
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !174
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !172
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !172
  %34 = load i8* %b.18, align 1, !dbg !172, !tbaa !159
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !172
  store i8 %34, i8* %a.17, align 1, !dbg !172, !tbaa !159
  %36 = icmp eq i64 %32, 0, !dbg !172
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !172, !llvm.loop !175
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #1 {
  ...
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !177
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum280 = or i64 %index, 16, !dbg !178
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !178
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !178
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !178
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !178
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !178
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !178
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !178
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !178
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !178, !tbaa !159
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !178
  store i8 %12, i8* %dest.02, align 1, !dbg !178, !tbaa !159
  %14 = icmp eq i64 %10, 0, !dbg !177
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !177, !llvm.loop !180
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !181
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #1 {
  %1 = icmp eq i64 %count, 0, !dbg !182
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !182

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !183
  br label %3, !dbg !182

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !182
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !183
  store volatile i8 %2, i8* %a.02, align 1, !dbg !183, !tbaa !159
  %6 = icmp eq i64 %4, 0, !dbg !182
  br i1 %6, label %._crit_edge, label %3, !dbg !182
...
!121 = metadata !{i32 181}
!122 = metadata !{i32 13, i32 0, metadata !123, null}
!123 = metadata !{i32 786443, metadata !6, metadata !5, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!124 = metadata !{i32 14, i32 0, metadata !123, null}
!125 = metadata !{i32 15, i32 0, metadata !5, null}
!126 = metadata !{i32 15, i32 0, metadata !16, null}
!127 = metadata !{i32 16, i32 0, metadata !16, null}
!128 = metadata !{metadata !129, metadata !129, i64 0}
!129 = metadata !{metadata !"int", metadata !130, i64 0}
!130 = metadata !{metadata !"omnipotent char", metadata !131, i64 0}
...
!159 = metadata !{metadata !130, metadata !130, i64 0}
!160 = metadata !{metadata !160, metadata !157, metadata !158}
!161 = metadata !{i32 18, i32 0, metadata !56, null}
!162 = metadata !{i32 16, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !77, metadata !76, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!164 = metadata !{i32 19, i32 0, metadata !165, null}
!165 = metadata !{i32 786443, metadata !77, metadata !76, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!166 = metadata !{i32 20, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !77, metadata !165, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!168 = metadata !{metadata !168, metadata !157, metadata !158}
!169 = metadata !{metadata !169, metadata !157, metadata !158}
!170 = metadata !{i32 22, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !77, metadata !165, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!172 = metadata !{i32 24, i32 0, metadata !171, null}
!173 = metadata !{i32 23, i32 0, metadata !171, null}
!174 = metadata !{metadata !174, metadata !157, metadata !158}
!175 = metadata !{metadata !175, metadata !157, metadata !158}
!176 = metadata !{i32 28, i32 0, metadata !76, null}
!177 = metadata !{i32 15, i32 0, metadata !91, null}
!178 = metadata !{i32 16, i32 0, metadata !91, null}
!179 = metadata !{metadata !179, metadata !157, metadata !158}
!180 = metadata !{metadata !180, metadata !157, metadata !158}
!181 = metadata !{i32 17, i32 0, metadata !91, null}
!182 = metadata !{i32 13, i32 0, metadata !106, null}
!183 = metadata !{i32 14, i32 0, metadata !106, null}
!184 = metadata !{i32 15, i32 0, metadata !106, null}
