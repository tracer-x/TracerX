; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2016-08-11-entry-point-internalize-pass.c.tmp.bc'
...
define void @klee_div_zero_check(i64 %z) #1 {
  %1 = icmp eq i64 %z, 0, !dbg !129
  br i1 %1, label %2, label %3, !dbg !129

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #5, !dbg !131
  unreachable, !dbg !131
...
define i32 @klee_int(i8* %name) #1 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #6, !dbg !133
  %2 = load i32* %x, align 4, !dbg !134, !tbaa !135
  ret i32 %2, !dbg !134
}
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #1 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !139
  br i1 %1, label %3, label %2, !dbg !139

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #5, !dbg !141
  unreachable, !dbg !141
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #1 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !144
  br i1 %1, label %3, label %2, !dbg !144

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #5, !dbg !146
  unreachable, !dbg !146

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !147
  %5 = icmp eq i32 %4, %end, !dbg !147
  br i1 %5, label %21, label %6, !dbg !147

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !149
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #6, !dbg !149
  %8 = icmp eq i32 %start, 0, !dbg !151
  %9 = load i32* %x, align 4, !dbg !153, !tbaa !135
  br i1 %8, label %10, label %13, !dbg !151

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !153
  %12 = zext i1 %11 to i64, !dbg !153
  call void @klee_assume(i64 %12) #6, !dbg !153
  br label %19, !dbg !155

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !156
  %15 = zext i1 %14 to i64, !dbg !156
  call void @klee_assume(i64 %15) #6, !dbg !156
  %16 = load i32* %x, align 4, !dbg !158, !tbaa !135
  %17 = icmp slt i32 %16, %end, !dbg !158
  %18 = zext i1 %17 to i64, !dbg !158
  call void @klee_assume(i64 %18) #6, !dbg !158
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !159, !tbaa !135
  br label %21, !dbg !159
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #1 {
  %1 = icmp eq i64 %len, 0, !dbg !161
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !161
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !162
  %wide.load = load <16 x i8>* %3, align 1, !dbg !162
  %next.gep.sum279 = or i64 %index, 16, !dbg !162
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !162
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !162
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !162
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !162
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !162
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !162
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !162
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !162
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !161
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !162
  %12 = load i8* %src.03, align 1, !dbg !162, !tbaa !166
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !162
  store i8 %12, i8* %dest.02, align 1, !dbg !162, !tbaa !166
  %14 = icmp eq i64 %10, 0, !dbg !161
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !161, !llvm.loop !167

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !168
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #1 {
  %1 = icmp eq i8* %src, %dst, !dbg !169
  br i1 %1, label %.loopexit, label %2, !dbg !169

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !171
  br i1 %3, label %.preheader, label %18, !dbg !171

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !173
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !173
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !173
  %wide.load = load <16 x i8>* %6, align 1, !dbg !173
  %next.gep.sum586 = or i64 %index, 16, !dbg !173
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !173
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !173
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !173
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !173
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !173
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !173
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !173
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !173
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !175
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !173
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !173
  %15 = load i8* %b.04, align 1, !dbg !173, !tbaa !166
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !173
  store i8 %15, i8* %a.03, align 1, !dbg !173, !tbaa !166
  %17 = icmp eq i64 %13, 0, !dbg !173
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !173, !llvm.loop !176

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !177
  %20 = icmp eq i64 %count, 0, !dbg !179
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !179

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !180
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !177
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !179
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !179
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !179
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !179
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !179
  %.sum505 = add i64 %.sum440, -31, !dbg !179
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !179
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !179
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !179
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !179
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !179
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !179
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !179
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !179
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !179
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !179
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !179
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !179
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !181
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !179
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !179
  %34 = load i8* %b.18, align 1, !dbg !179, !tbaa !166
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !179
  store i8 %34, i8* %a.17, align 1, !dbg !179, !tbaa !166
  %36 = icmp eq i64 %32, 0, !dbg !179
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !179, !llvm.loop !182
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #1 {
  ...
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !184
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum280 = or i64 %index, 16, !dbg !185
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !185
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !185
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !185
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !185
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !185
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !185
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !185
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !185
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !185, !tbaa !166
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !185
  store i8 %12, i8* %dest.02, align 1, !dbg !185, !tbaa !166
  %14 = icmp eq i64 %10, 0, !dbg !184
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !184, !llvm.loop !187
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !188
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #1 {
  %1 = icmp eq i64 %count, 0, !dbg !189
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !189

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !190
  br label %3, !dbg !189

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !189
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !190
  store volatile i8 %2, i8* %a.02, align 1, !dbg !190, !tbaa !166
  %6 = icmp eq i64 %4, 0, !dbg !189
  br i1 %6, label %._crit_edge, label %3, !dbg !189
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2016-08-11-entry-point-internalize-pass.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"entry", metadata !"entry", metadata !"", i32 5, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @entry, null, null, metadata !2, i32 5} ; [ DW_TAG_subprogram ] 
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2016-08-11-entry-point-internalize-pass.c]
...
!128 = metadata !{i32 5, i32 0, metadata !4, null}
!129 = metadata !{i32 13, i32 0, metadata !130, null}
!130 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!131 = metadata !{i32 14, i32 0, metadata !130, null}
!132 = metadata !{i32 15, i32 0, metadata !12, null}
!133 = metadata !{i32 15, i32 0, metadata !23, null}
!134 = metadata !{i32 16, i32 0, metadata !23, null}
!135 = metadata !{metadata !136, metadata !136, i64 0}
!136 = metadata !{metadata !"int", metadata !137, i64 0}
!137 = metadata !{metadata !"omnipotent char", metadata !138, i64 0}
!138 = metadata !{metadata !"Simple C/C++ TBAA"}
!139 = metadata !{i32 21, i32 0, metadata !140, null}
!140 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!141 = metadata !{i32 27, i32 0, metadata !142, null}
!142 = metadata !{i32 786443, metadata !38, metadata !140, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!143 = metadata !{i32 29, i32 0, metadata !37, null}
!144 = metadata !{i32 16, i32 0, metadata !145, null}
!145 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!146 = metadata !{i32 17, i32 0, metadata !145, null}
!147 = metadata !{i32 19, i32 0, metadata !148, null}
!148 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!149 = metadata !{i32 22, i32 0, metadata !150, null}
!150 = metadata !{i32 786443, metadata !50, metadata !148, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!151 = metadata !{i32 25, i32 0, metadata !152, null}
!152 = metadata !{i32 786443, metadata !50, metadata !150, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!153 = metadata !{i32 26, i32 0, metadata !154, null}
!154 = metadata !{i32 786443, metadata !50, metadata !152, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!155 = metadata !{i32 27, i32 0, metadata !154, null}
!156 = metadata !{i32 28, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !50, metadata !152, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!158 = metadata !{i32 29, i32 0, metadata !157, null}
!159 = metadata !{i32 32, i32 0, metadata !150, null}
!160 = metadata !{i32 34, i32 0, metadata !49, null}
!161 = metadata !{i32 16, i32 0, metadata !62, null}
!162 = metadata !{i32 17, i32 0, metadata !62, null}
!163 = metadata !{metadata !163, metadata !164, metadata !165}
!164 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!165 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!166 = metadata !{metadata !137, metadata !137, i64 0}
!167 = metadata !{metadata !167, metadata !164, metadata !165}
!168 = metadata !{i32 18, i32 0, metadata !62, null}
!169 = metadata !{i32 16, i32 0, metadata !170, null}
!170 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!171 = metadata !{i32 19, i32 0, metadata !172, null}
!172 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!173 = metadata !{i32 20, i32 0, metadata !174, null}
!174 = metadata !{i32 786443, metadata !83, metadata !172, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!175 = metadata !{metadata !175, metadata !164, metadata !165}
!176 = metadata !{metadata !176, metadata !164, metadata !165}
!177 = metadata !{i32 22, i32 0, metadata !178, null}
!178 = metadata !{i32 786443, metadata !83, metadata !172, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!179 = metadata !{i32 24, i32 0, metadata !178, null}
!180 = metadata !{i32 23, i32 0, metadata !178, null}
!181 = metadata !{metadata !181, metadata !164, metadata !165}
!182 = metadata !{metadata !182, metadata !164, metadata !165}
!183 = metadata !{i32 28, i32 0, metadata !82, null}
!184 = metadata !{i32 15, i32 0, metadata !97, null}
!185 = metadata !{i32 16, i32 0, metadata !97, null}
!186 = metadata !{metadata !186, metadata !164, metadata !165}
!187 = metadata !{metadata !187, metadata !164, metadata !165}
!188 = metadata !{i32 17, i32 0, metadata !97, null}
!189 = metadata !{i32 13, i32 0, metadata !112, null}
!190 = metadata !{i32 14, i32 0, metadata !112, null}
!191 = metadata !{i32 15, i32 0, metadata !112, null}
