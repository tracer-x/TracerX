; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2007-07-30-unflushed-byte.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  %y = alloca i8, align 1
  store i32 0, i32* %1
  %2 = call i32 (i8*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i64, ...)*)(i8* %i, i64 1)
  %3 = load i8* %i, align 1
  %4 = getelementptr inbounds [3 x i8]* %x, i32 0, i64 0
  store i8 %3, i8* %4, align 1
  %5 = getelementptr inbounds [3 x i8]* %x, i32 0, i64 1
  %6 = load i8* %5, align 1
