; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2016-08-06-klee-get-obj-size.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [26 x i8] c"5 != klee_get_obj_size(s)\00", align 1
@.str1 = private unnamed_addr constant [76 x i8] c"/home/sanghu/TracerX/tracerx/test/regression/2016-08-06-klee-get-obj-size.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = getelementptr inbounds [5 x i8]* %s, i32 0, i32 0, !dbg !128
  %3 = call i64 @klee_get_obj_size(i8* %2), !dbg !128
  %4 = icmp ne i64 5, %3, !dbg !128
  br i1 %4, label %5, label %6, !dbg !128

; <label>:5                                       ; preds = %0
  br label %8, !dbg !128

; <label>:6                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([26 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([76 x i8]* @.str1, i32 0, i32 0), i32 11, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7, !dbg !128
  unreachable, !dbg !128
                                                  ; No predecessors!
  br label %8, !dbg !128
...
declare i64 @klee_get_obj_size(i8*) #2
...
define void @klee_div_zero_check(i64 %z) #4 {
  %1 = icmp eq i64 %z, 0, !dbg !130
  br i1 %1, label %2, label %3, !dbg !130

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #8, !dbg !132
  unreachable, !dbg !132
...
define i32 @klee_int(i8* %name) #4 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #9, !dbg !134
  %2 = load i32* %x, align 4, !dbg !135, !tbaa !136
  ret i32 %2, !dbg !135
}
...
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #4 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !140
  br i1 %1, label %3, label %2, !dbg !140

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !142
  unreachable, !dbg !142
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #4 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !145
  br i1 %1, label %3, label %2, !dbg !145

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #8, !dbg !147
  unreachable, !dbg !147

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !148
  %5 = icmp eq i32 %4, %end, !dbg !148
  br i1 %5, label %21, label %6, !dbg !148

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !150
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #9, !dbg !150
  %8 = icmp eq i32 %start, 0, !dbg !152
  %9 = load i32* %x, align 4, !dbg !154, !tbaa !136
  br i1 %8, label %10, label %13, !dbg !152

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !154
  %12 = zext i1 %11 to i64, !dbg !154
  call void @klee_assume(i64 %12) #9, !dbg !154
  br label %19, !dbg !156

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !157
  %15 = zext i1 %14 to i64, !dbg !157
  call void @klee_assume(i64 %15) #9, !dbg !157
  %16 = load i32* %x, align 4, !dbg !159, !tbaa !136
  %17 = icmp slt i32 %16, %end, !dbg !159
  %18 = zext i1 %17 to i64, !dbg !159
  call void @klee_assume(i64 %18) #9, !dbg !159
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !160, !tbaa !136
  br label %21, !dbg !160
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  %1 = icmp eq i64 %len, 0, !dbg !162
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !162
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !163
  %wide.load = load <16 x i8>* %3, align 1, !dbg !163
  %next.gep.sum279 = or i64 %index, 16, !dbg !163
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !163
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !163
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !163
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !163
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !163
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !163
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !163
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !163
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
  br i1 %9, label %middle.block, label %vector.body, !llvm.loop !164
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !162
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !163
  %12 = load i8* %src.03, align 1, !dbg !163, !tbaa !167
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !163
  store i8 %12, i8* %dest.02, align 1, !dbg !163, !tbaa !167
  %14 = icmp eq i64 %10, 0, !dbg !162
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !162, !llvm.loop !168

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !169
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #4 {
  %1 = icmp eq i8* %src, %dst, !dbg !170
  br i1 %1, label %.loopexit, label %2, !dbg !170

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !172
  br i1 %3, label %.preheader, label %18, !dbg !172

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !174
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !174
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !174
  %wide.load = load <16 x i8>* %6, align 1, !dbg !174
  %next.gep.sum586 = or i64 %index, 16, !dbg !174
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !174
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !174
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !174
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !174
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !174
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !174
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !174
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !174
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !176
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !174
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !174
  %15 = load i8* %b.04, align 1, !dbg !174, !tbaa !167
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !174
  store i8 %15, i8* %a.03, align 1, !dbg !174, !tbaa !167
  %17 = icmp eq i64 %13, 0, !dbg !174
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !174, !llvm.loop !177

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !178
  %20 = icmp eq i64 %count, 0, !dbg !180
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !180

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !181
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !178
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !180
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !180
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !180
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !180
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !180
  %.sum505 = add i64 %.sum440, -31, !dbg !180
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !180
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !180
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !180
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !180
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !180
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !180
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !180
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !180
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !180
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !180
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !180
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !180
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !182
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !180
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !180
  %34 = load i8* %b.18, align 1, !dbg !180, !tbaa !167
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !180
  store i8 %34, i8* %a.17, align 1, !dbg !180, !tbaa !167
  %36 = icmp eq i64 %32, 0, !dbg !180
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !180, !llvm.loop !183
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  ...
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !185
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum280 = or i64 %index, 16, !dbg !186
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !186
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !186
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !186
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !186
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !186
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !186
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !186
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !186
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !186, !tbaa !167
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !186
  store i8 %12, i8* %dest.02, align 1, !dbg !186, !tbaa !167
  %14 = icmp eq i64 %10, 0, !dbg !185
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !185, !llvm.loop !188
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !189
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #4 {
  %1 = icmp eq i64 %count, 0, !dbg !190
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !190

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !191
  br label %3, !dbg !190

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !190
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !191
  store volatile i8 %2, i8* %a.02, align 1, !dbg !191, !tbaa !167
  %6 = icmp eq i64 %4, 0, !dbg !190
  br i1 %6, label %._crit_edge, label %3, !dbg !190
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2016-08-06-klee-get-obj-size.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2016-08-06-klee-get-obj-size.c]
...
!129 = metadata !{i32 12, i32 0, metadata !4, null}
!130 = metadata !{i32 13, i32 0, metadata !131, null}
!131 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!132 = metadata !{i32 14, i32 0, metadata !131, null}
!133 = metadata !{i32 15, i32 0, metadata !12, null}
!134 = metadata !{i32 15, i32 0, metadata !23, null}
!135 = metadata !{i32 16, i32 0, metadata !23, null}
!136 = metadata !{metadata !137, metadata !137, i64 0}
!137 = metadata !{metadata !"int", metadata !138, i64 0}
...
!141 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!142 = metadata !{i32 27, i32 0, metadata !143, null}
!143 = metadata !{i32 786443, metadata !38, metadata !141, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!144 = metadata !{i32 29, i32 0, metadata !37, null}
!145 = metadata !{i32 16, i32 0, metadata !146, null}
!146 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!147 = metadata !{i32 17, i32 0, metadata !146, null}
!148 = metadata !{i32 19, i32 0, metadata !149, null}
!149 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!150 = metadata !{i32 22, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !50, metadata !149, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!152 = metadata !{i32 25, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !50, metadata !151, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!154 = metadata !{i32 26, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !50, metadata !153, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!156 = metadata !{i32 27, i32 0, metadata !155, null}
!157 = metadata !{i32 28, i32 0, metadata !158, null}
!158 = metadata !{i32 786443, metadata !50, metadata !153, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!159 = metadata !{i32 29, i32 0, metadata !158, null}
!160 = metadata !{i32 32, i32 0, metadata !151, null}
!161 = metadata !{i32 34, i32 0, metadata !49, null}
!162 = metadata !{i32 16, i32 0, metadata !62, null}
!163 = metadata !{i32 17, i32 0, metadata !62, null}
!164 = metadata !{metadata !164, metadata !165, metadata !166}
!165 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!166 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!167 = metadata !{metadata !138, metadata !138, i64 0}
!168 = metadata !{metadata !168, metadata !165, metadata !166}
!169 = metadata !{i32 18, i32 0, metadata !62, null}
!170 = metadata !{i32 16, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!172 = metadata !{i32 19, i32 0, metadata !173, null}
!173 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!174 = metadata !{i32 20, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !83, metadata !173, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!176 = metadata !{metadata !176, metadata !165, metadata !166}
!177 = metadata !{metadata !177, metadata !165, metadata !166}
!178 = metadata !{i32 22, i32 0, metadata !179, null}
!179 = metadata !{i32 786443, metadata !83, metadata !173, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!180 = metadata !{i32 24, i32 0, metadata !179, null}
!181 = metadata !{i32 23, i32 0, metadata !179, null}
!182 = metadata !{metadata !182, metadata !165, metadata !166}
!183 = metadata !{metadata !183, metadata !165, metadata !166}
!184 = metadata !{i32 28, i32 0, metadata !82, null}
!185 = metadata !{i32 15, i32 0, metadata !97, null}
!186 = metadata !{i32 16, i32 0, metadata !97, null}
!187 = metadata !{metadata !187, metadata !165, metadata !166}
!188 = metadata !{metadata !188, metadata !165, metadata !166}
!189 = metadata !{i32 17, i32 0, metadata !97, null}
!190 = metadata !{i32 13, i32 0, metadata !112, null}
!191 = metadata !{i32 14, i32 0, metadata !112, null}
!192 = metadata !{i32 15, i32 0, metadata !112, null}
