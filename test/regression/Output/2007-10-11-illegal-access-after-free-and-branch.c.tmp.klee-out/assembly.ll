; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2007-10-11-illegal-access-after-free-and-branch.c.tmp1.bc'
...
define i32 @main(i32 %argc, i8** nocapture readnone %argv) #0 {
  %1 = tail call noalias i8* @malloc(i64 3) #8, !dbg !129
  %2 = tail call i32 (i8*, i32, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i32, ...)*)(i8* %1, i32 3) #8, !dbg !130
  %3 = load i8* %1, align 1, !dbg !131
  %4 = icmp ugt i8 %3, 4, !dbg !131
  br i1 %4, label %5, label %7, !dbg !131

; <label>:5                                       ; preds = %0
  %6 = tail call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0) #8, !dbg !131
  br label %7, !dbg !131

; <label>:7                                       ; preds = %5, %0
  %8 = getelementptr inbounds i8* %1, i64 1, !dbg !133
  %9 = load i8* %8, align 1, !dbg !133
  tail call void @free(i8* %1) #8, !dbg !134
  %10 = icmp eq i8 %9, 0, !dbg !135
  br i1 %10, label %15, label %11, !dbg !135

; <label>:11                                      ; preds = %7
  %12 = getelementptr inbounds i8* %1, i64 2, !dbg !137
  %13 = load i8* %12, align 1, !dbg !137
  %14 = zext i8 %13 to i32, !dbg !137
  br label %17, !dbg !137

; <label>:15                                      ; preds = %7
  %16 = tail call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0) #8, !dbg !139
  br label %17, !dbg !140
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #9, !dbg !144
  unreachable, !dbg !144
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #10, !dbg !146
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #9, !dbg !154
  unreachable, !dbg !154
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #9, !dbg !159
  unreachable, !dbg !159
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #10, !dbg !162
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2007-10-11-illegal-access-after-free-and-branch.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2007-10-11-illegal-access-after-free-and-branch.c]
...
!130 = metadata !{i32 12, i32 0, metadata !4, null}
!131 = metadata !{i32 13, i32 0, metadata !132, null}
!132 = metadata !{i32 786443, metadata !1, metadata !4, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2007-10-11-illegal-access-after-free-and-branch.c]
!133 = metadata !{i32 14, i32 0, metadata !4, null}
!134 = metadata !{i32 15, i32 0, metadata !4, null}
!135 = metadata !{i32 16, i32 0, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !4, i32 16, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2007-10-11-illegal-access-after-free-and-branch.c]
!137 = metadata !{i32 19, i32 0, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !136, i32 17, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2007-10-11-illegal-access-after-free-and-branch.c]
!139 = metadata !{i32 21, i32 0, metadata !4, null}
!140 = metadata !{i32 22, i32 0, metadata !4, null}
!141 = metadata !{i32 23, i32 0, metadata !4, null}
