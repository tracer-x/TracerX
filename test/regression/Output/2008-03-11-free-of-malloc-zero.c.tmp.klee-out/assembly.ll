; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2008-03-11-free-of-malloc-zero.c.tmp1.bc'
...
define i32 @main() #0 {
  %p = alloca i8*, align 8
  %arr = alloca [4 x i8*], align 16
  %1 = call noalias i8* @malloc(i64 0) #2
  store i8* %1, i8** %p, align 8
  %2 = load i8** %p, align 8
  call void @free(i8* %2) #2
  %3 = call noalias i8* @malloc(i64 0) #2
  store i8* %3, i8** %p, align 8
  %4 = bitcast [4 x i8*]* %arr to i8*
  %5 = call i8* @memset(i8* %4, i32 0, i64 32)
  %6 = getelementptr inbounds [4 x i8*]* %arr, i64 0, i64 0
  %7 = load i8** %p, align 8
  store i8* %7, i8** %6
  %8 = getelementptr inbounds i8** %6, i64 1
  %9 = getelementptr inbounds i8** %8, i64 1
  %10 = getelementptr inbounds i8** %9, i64 1
  %11 = call i32 (i32, i32, i8*, ...)* bitcast (i32 (i32, i32, i8*)* @klee_range to i32 (i32, i32, i8*, ...)*)(i32 0, i32 4, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0))
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds [4 x i8*]* %arr, i32 0, i64 %12
