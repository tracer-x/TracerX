; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2007-08-01-cache-unclear-on-overwrite-flushed.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@main.delete = private unnamed_addr constant [2 x i8] c"\00\01", align 1
@.str = private unnamed_addr constant [15 x i8] c"delete[1] == 0\00", align 1
@.str1 = private unnamed_addr constant [93 x i8] c"/home/sanghu/TracerX/tracerx/test/regression/2007-08-01-cache-unclear-on-overwrite-flushed.c\00", align 1
...
define i32 @main() #0 {
  ...
  %x = alloca i8, align 1
  %delete = alloca [2 x i8], align 1
  %tmp = alloca i8, align 1
  %tmp2 = alloca i8, align 1
  store i32 0, i32* %1
  %2 = call i32 (i8*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i8*, i64, ...)*)(i8* %x, i64 1)
  %3 = load i8* %x, align 1
  %4 = zext i8 %3 to i32
  %5 = icmp sge i32 %4, 2
...
; <label>:6                                       ; preds = %0
  %7 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %8

; <label>:8                                       ; preds = %6, %0
  %9 = bitcast [2 x i8]* %delete to i8*
  %10 = call i8* @memcpy(i8* %9, i8* getelementptr inbounds ([2 x i8]* @main.delete, i32 0, i32 0), i64 2)
  %11 = load i8* %x, align 1
  %12 = zext i8 %11 to i64
  %13 = getelementptr inbounds [2 x i8]* %delete, i32 0, i64 %12
  %14 = load i8* %13, align 1
  store i8 %14, i8* %tmp, align 1
  %15 = getelementptr inbounds [2 x i8]* %delete, i32 0, i64 0
  %16 = load i8* %15, align 1
  store i8 %16, i8* %tmp2, align 1
  %17 = load i8* %tmp2, align 1
  %18 = load i8* %x, align 1
  %19 = zext i8 %18 to i64
  %20 = getelementptr inbounds [2 x i8]* %delete, i32 0, i64 %19
  store i8 %17, i8* %20, align 1
  %21 = load i8* %x, align 1
  %22 = zext i8 %21 to i32
  %23 = icmp eq i32 %22, 1
  br i1 %23, label %24, label %33

; <label>:24                                      ; preds = %8
  %25 = getelementptr inbounds [2 x i8]* %delete, i32 0, i64 1
...
; <label>:30                                      ; preds = %24
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([93 x i8]* @.str1, i32 0, i32 0), i32 21, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #9
  unreachable
                                                  ; No predecessors!
  br label %32
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #10, !dbg !123
  unreachable, !dbg !123
...
define i32 @klee_int(i8* %name) #5 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #11, !dbg !125
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #10, !dbg !133
  unreachable, !dbg !133
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #10, !dbg !138
  unreachable, !dbg !138
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #11, !dbg !141
