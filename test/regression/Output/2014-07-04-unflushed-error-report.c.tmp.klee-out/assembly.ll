; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2014-07-04-unflushed-error-report.c.tmp.bc'
...
define void @klee_div_zero_check(i64 %z) #3 {
  %1 = icmp eq i64 %z, 0, !dbg !132
  br i1 %1, label %2, label %3, !dbg !132

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str1, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #6, !dbg !134
  unreachable, !dbg !134
...
define i32 @klee_int(i8* %name) #3 {
  %x = alloca i32, align 4
  %1 = bitcast i32* %x to i8*, !dbg !136
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #7, !dbg !136
  %2 = load i32* %x, align 4, !dbg !137, !tbaa !138
  ret i32 %2, !dbg !137
}

; Function Attrs: nounwind uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #3 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !142
  br i1 %1, label %3, label %2, !dbg !142

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !144
  unreachable, !dbg !144
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #3 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !147
  br i1 %1, label %3, label %2, !dbg !147

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #6, !dbg !149
  unreachable, !dbg !149

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !150
  %5 = icmp eq i32 %4, %end, !dbg !150
  br i1 %5, label %21, label %6, !dbg !150

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !152
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #7, !dbg !152
  %8 = icmp eq i32 %start, 0, !dbg !154
  %9 = load i32* %x, align 4, !dbg !156, !tbaa !138
  br i1 %8, label %10, label %13, !dbg !154

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !156
  %12 = zext i1 %11 to i64, !dbg !156
  call void @klee_assume(i64 %12) #7, !dbg !156
  br label %19, !dbg !158

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !159
  %15 = zext i1 %14 to i64, !dbg !159
  call void @klee_assume(i64 %15) #7, !dbg !159
  %16 = load i32* %x, align 4, !dbg !161, !tbaa !138
  %17 = icmp slt i32 %16, %end, !dbg !161
  %18 = zext i1 %17 to i64, !dbg !161
  call void @klee_assume(i64 %18) #7, !dbg !161
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !162, !tbaa !138
  br label %21, !dbg !162
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  %1 = icmp eq i64 %len, 0, !dbg !164
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !164
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %3 = bitcast i8* %next.gep to <16 x i8>*, !dbg !165
  %wide.load = load <16 x i8>* %3, align 1, !dbg !165
  %next.gep.sum279 = or i64 %index, 16, !dbg !165
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !165
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !165
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !165
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !165
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !165
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !165
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !165
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !165
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %10 = add i64 %.01, -1, !dbg !164
  %11 = getelementptr inbounds i8* %src.03, i64 1, !dbg !165
  %12 = load i8* %src.03, align 1, !dbg !165, !tbaa !169
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !165
  store i8 %12, i8* %dest.02, align 1, !dbg !165, !tbaa !169
  %14 = icmp eq i64 %10, 0, !dbg !164
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !164, !llvm.loop !170

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !171
}

; Function Attrs: nounwind uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #3 {
  %1 = icmp eq i8* %src, %dst, !dbg !172
  br i1 %1, label %.loopexit, label %2, !dbg !172

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !174
  br i1 %3, label %.preheader, label %18, !dbg !174

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !176
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !176
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !176
  %wide.load = load <16 x i8>* %6, align 1, !dbg !176
  %next.gep.sum586 = or i64 %index, 16, !dbg !176
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !176
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !176
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !176
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !176
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !176
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !176
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !176
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !176
  %index.next = add i64 %index, 32
  %12 = icmp eq i64 %index.next, %n.vec
  br i1 %12, label %middle.block, label %vector.body, !llvm.loop !178
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !176
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !176
  %15 = load i8* %b.04, align 1, !dbg !176, !tbaa !169
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !176
  store i8 %15, i8* %a.03, align 1, !dbg !176, !tbaa !169
  %17 = icmp eq i64 %13, 0, !dbg !176
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !176, !llvm.loop !179

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !180
  %20 = icmp eq i64 %count, 0, !dbg !182
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !182

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !183
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !180
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !182
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !182
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !182
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !182
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !182
  %.sum505 = add i64 %.sum440, -31, !dbg !182
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !182
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !182
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !182
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !182
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !182
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !182
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !182
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !182
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !182
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !182
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !182
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !182
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !184
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !182
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !182
  %34 = load i8* %b.18, align 1, !dbg !182, !tbaa !169
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !182
  store i8 %34, i8* %a.17, align 1, !dbg !182, !tbaa !169
  %36 = icmp eq i64 %32, 0, !dbg !182
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !182, !llvm.loop !185
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #3 {
  ...
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !187
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum280 = or i64 %index, 16, !dbg !188
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !188
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !188
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !188
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !188
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !188
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !188
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !188
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !188
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !188, !tbaa !169
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !188
  store i8 %12, i8* %dest.02, align 1, !dbg !188, !tbaa !169
  %14 = icmp eq i64 %10, 0, !dbg !187
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !187, !llvm.loop !190
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !191
}

; Function Attrs: nounwind uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #3 {
  %1 = icmp eq i64 %count, 0, !dbg !192
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !192

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !193
  br label %3, !dbg !192

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !192
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !193
  store volatile i8 %2, i8* %a.02, align 1, !dbg !193, !tbaa !169
  %6 = icmp eq i64 %4, 0, !dbg !192
  br i1 %6, label %._crit_edge, label %3, !dbg !192
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2014-07-04-unflushed-error-report.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 9, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 10} ; [ DW_TAG_subprogram ] [l
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2014-07-04-unflushed-error-report.c]
...
!129 = metadata !{i32 17, i32 0, metadata !4, null}
!130 = metadata !{i32 23, i32 0, metadata !4, null}
!131 = metadata !{i32 25, i32 0, metadata !4, null}
!132 = metadata !{i32 13, i32 0, metadata !133, null}
!133 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!134 = metadata !{i32 14, i32 0, metadata !133, null}
!135 = metadata !{i32 15, i32 0, metadata !12, null}
!136 = metadata !{i32 15, i32 0, metadata !23, null}
!137 = metadata !{i32 16, i32 0, metadata !23, null}
!138 = metadata !{metadata !139, metadata !139, i64 0}
!139 = metadata !{metadata !"int", metadata !140, i64 0}
!140 = metadata !{metadata !"omnipotent char", metadata !141, i64 0}
!141 = metadata !{metadata !"Simple C/C++ TBAA"}
!142 = metadata !{i32 21, i32 0, metadata !143, null}
!143 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!144 = metadata !{i32 27, i32 0, metadata !145, null}
!145 = metadata !{i32 786443, metadata !38, metadata !143, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!146 = metadata !{i32 29, i32 0, metadata !37, null}
!147 = metadata !{i32 16, i32 0, metadata !148, null}
!148 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!149 = metadata !{i32 17, i32 0, metadata !148, null}
!150 = metadata !{i32 19, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!152 = metadata !{i32 22, i32 0, metadata !153, null}
!153 = metadata !{i32 786443, metadata !50, metadata !151, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!154 = metadata !{i32 25, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !50, metadata !153, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!156 = metadata !{i32 26, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !50, metadata !155, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!158 = metadata !{i32 27, i32 0, metadata !157, null}
!159 = metadata !{i32 28, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !50, metadata !155, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!161 = metadata !{i32 29, i32 0, metadata !160, null}
!162 = metadata !{i32 32, i32 0, metadata !153, null}
!163 = metadata !{i32 34, i32 0, metadata !49, null}
!164 = metadata !{i32 16, i32 0, metadata !62, null}
!165 = metadata !{i32 17, i32 0, metadata !62, null}
!166 = metadata !{metadata !166, metadata !167, metadata !168}
!167 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!168 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!169 = metadata !{metadata !140, metadata !140, i64 0}
!170 = metadata !{metadata !170, metadata !167, metadata !168}
!171 = metadata !{i32 18, i32 0, metadata !62, null}
!172 = metadata !{i32 16, i32 0, metadata !173, null}
!173 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!174 = metadata !{i32 19, i32 0, metadata !175, null}
!175 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!176 = metadata !{i32 20, i32 0, metadata !177, null}
!177 = metadata !{i32 786443, metadata !83, metadata !175, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!178 = metadata !{metadata !178, metadata !167, metadata !168}
!179 = metadata !{metadata !179, metadata !167, metadata !168}
!180 = metadata !{i32 22, i32 0, metadata !181, null}
!181 = metadata !{i32 786443, metadata !83, metadata !175, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!182 = metadata !{i32 24, i32 0, metadata !181, null}
!183 = metadata !{i32 23, i32 0, metadata !181, null}
!184 = metadata !{metadata !184, metadata !167, metadata !168}
!185 = metadata !{metadata !185, metadata !167, metadata !168}
!186 = metadata !{i32 28, i32 0, metadata !82, null}
!187 = metadata !{i32 15, i32 0, metadata !97, null}
!188 = metadata !{i32 16, i32 0, metadata !97, null}
!189 = metadata !{metadata !189, metadata !167, metadata !168}
!190 = metadata !{metadata !190, metadata !167, metadata !168}
!191 = metadata !{i32 17, i32 0, metadata !97, null}
!192 = metadata !{i32 13, i32 0, metadata !112, null}
!193 = metadata !{i32 14, i32 0, metadata !112, null}
!194 = metadata !{i32 15, i32 0, metadata !112, null}
