; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2016-04-14-sdiv-2.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"n\00", align 1
@.str1 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str2 = private unnamed_addr constant [65 x i8] c"/home/sanghu/TracerX/tracerx/test/regression/2016-04-14-sdiv-2.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str3 = private unnamed_addr constant [2 x i8] c"m\00", align 1
@.str4 = private unnamed_addr constant [8 x i8] c"m is 2\0A\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast i32* %n to i8*, !dbg !128
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !dbg !128
  %3 = load i32* %n, align 4, !dbg !129
  %4 = icmp slt i32 %3, -1, !dbg !129
  %5 = zext i1 %4 to i32, !dbg !129
  %6 = sext i32 %5 to i64, !dbg !129
  call void @klee_assume(i64 %6), !dbg !129
  %7 = load i32* %n, align 4, !dbg !130
  %int_cast_to_i64 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !130
  %8 = sdiv i32 %7, 2, !dbg !130
  %9 = icmp sgt i32 %8, 0, !dbg !130
  br i1 %9, label %10, label %11, !dbg !130

; <label>:10                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([65 x i8]* @.str2, i32 0, i32 0), i32 16, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6, !dbg !132
  unreachable, !dbg !132

; <label>:11                                      ; preds = %0
  %12 = bitcast i32* %m to i8*, !dbg !133
  call void @klee_make_symbolic(i8* %12, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str3, i32 0, i32 0)), !dbg !133
  %13 = load i32* %m, align 4, !dbg !134
  %14 = icmp sgt i32 %13, 0, !dbg !134
  %15 = zext i1 %14 to i32, !dbg !134
  %16 = sext i32 %15 to i64, !dbg !134
  call void @klee_assume(i64 %16), !dbg !134
  %17 = load i32* %m, align 4, !dbg !135
  %int_cast_to_i641 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !135
  %18 = sdiv i32 %17, 2, !dbg !135
  %19 = icmp eq i32 %18, 2, !dbg !135
  br i1 %19, label %20, label %22, !dbg !135

; <label>:20                                      ; preds = %11
  %21 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0)), !dbg !137
  br label %22, !dbg !137
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str5, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str16, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str27, i64 0, i64 0)) #7, !dbg !141
  unreachable, !dbg !141
...
define i32 @klee_int(i8* %name) #4 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #8, !dbg !143
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str38, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !151
  unreachable, !dbg !151
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !156
  unreachable, !dbg !156
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #8, !dbg !159
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2016-04-14-sdiv-2.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 10, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !2, i32 10} ; [ DW_TAG_subprogram ]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2016-04-14-sdiv-2.c]
...
!130 = metadata !{i32 15, i32 0, metadata !131, null}
!131 = metadata !{i32 786443, metadata !1, metadata !4, i32 15, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2016-04-14-sdiv-2.c]
!132 = metadata !{i32 16, i32 0, metadata !131, null}
!133 = metadata !{i32 18, i32 0, metadata !4, null}
!134 = metadata !{i32 19, i32 0, metadata !4, null}
!135 = metadata !{i32 21, i32 0, metadata !136, null}
!136 = metadata !{i32 786443, metadata !1, metadata !4, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2016-04-14-sdiv-2.c]
!137 = metadata !{i32 22, i32 0, metadata !136, null}
!138 = metadata !{i32 24, i32 0, metadata !4, null}
!139 = metadata !{i32 13, i32 0, metadata !140, null}
!140 = metadata !{i32 786443, metadata !13, metadata !12, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_div_zero_check.c]
!141 = metadata !{i32 14, i32 0, metadata !140, null}
!142 = metadata !{i32 15, i32 0, metadata !12, null}
!143 = metadata !{i32 15, i32 0, metadata !23, null}
!144 = metadata !{i32 16, i32 0, metadata !23, null}
...
!150 = metadata !{i32 786443, metadata !38, metadata !37, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!151 = metadata !{i32 27, i32 0, metadata !152, null}
!152 = metadata !{i32 786443, metadata !38, metadata !150, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_overshift_check.c]
!153 = metadata !{i32 29, i32 0, metadata !37, null}
!154 = metadata !{i32 16, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !50, metadata !49, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!156 = metadata !{i32 17, i32 0, metadata !155, null}
!157 = metadata !{i32 19, i32 0, metadata !158, null}
!158 = metadata !{i32 786443, metadata !50, metadata !49, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!159 = metadata !{i32 22, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !50, metadata !158, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!161 = metadata !{i32 25, i32 0, metadata !162, null}
!162 = metadata !{i32 786443, metadata !50, metadata !160, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!163 = metadata !{i32 26, i32 0, metadata !164, null}
!164 = metadata !{i32 786443, metadata !50, metadata !162, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!165 = metadata !{i32 27, i32 0, metadata !164, null}
!166 = metadata !{i32 28, i32 0, metadata !167, null}
!167 = metadata !{i32 786443, metadata !50, metadata !162, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/klee_range.c]
!168 = metadata !{i32 29, i32 0, metadata !167, null}
!169 = metadata !{i32 32, i32 0, metadata !160, null}
!170 = metadata !{i32 34, i32 0, metadata !49, null}
!171 = metadata !{i32 16, i32 0, metadata !62, null}
!172 = metadata !{i32 17, i32 0, metadata !62, null}
...
!178 = metadata !{i32 18, i32 0, metadata !62, null}
!179 = metadata !{i32 16, i32 0, metadata !180, null}
!180 = metadata !{i32 786443, metadata !83, metadata !82, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!181 = metadata !{i32 19, i32 0, metadata !182, null}
!182 = metadata !{i32 786443, metadata !83, metadata !82, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
!183 = metadata !{i32 20, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !83, metadata !182, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!188 = metadata !{i32 786443, metadata !83, metadata !182, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/runtime/Intrinsic/memmove.c]
...
!193 = metadata !{i32 28, i32 0, metadata !82, null}
!194 = metadata !{i32 15, i32 0, metadata !97, null}
!195 = metadata !{i32 16, i32 0, metadata !97, null}
!196 = metadata !{metadata !196, metadata !174, metadata !175}
!197 = metadata !{metadata !197, metadata !174, metadata !175}
!198 = metadata !{i32 17, i32 0, metadata !97, null}
!199 = metadata !{i32 13, i32 0, metadata !112, null}
!200 = metadata !{i32 14, i32 0, metadata !112, null}
!201 = metadata !{i32 15, i32 0, metadata !112, null}
