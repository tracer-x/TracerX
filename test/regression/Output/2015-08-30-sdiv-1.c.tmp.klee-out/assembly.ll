; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2015-08-30-sdiv-1.c.tmp.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %dividend, i64 4, i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0)), !dbg !128
  %3 = load i32* %dividend, align 4, !dbg !129
  %4 = and i32 %3, 2, !dbg !129
  %5 = xor i32 3, %4, !dbg !129
  %int_cast_to_i64 = zext i32 1 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !129
  %6 = sdiv i32 %5, 1, !dbg !129
  %7 = icmp ne i32 %6, 0, !dbg !129
...
; <label>:9                                       ; preds = %0
  %10 = load i32* %dividend, align 4, !dbg !132
  %11 = and i32 %10, 2, !dbg !132
  %12 = xor i32 3, %11, !dbg !132
  %int_cast_to_i641 = zext i32 -1 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i641), !dbg !132
  %13 = sdiv i32 %12, -1, !dbg !132
  %14 = icmp ne i32 %13, 0, !dbg !132
  br i1 %14, label %15, label %16, !dbg !132

; <label>:15                                      ; preds = %9
  store i32 1, i32* %1, !dbg !134
  br label %17, !dbg !134
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str1, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #6, !dbg !139
  unreachable, !dbg !139
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %1, i64 4, i8* %name) #7, !dbg !141
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #6, !dbg !149
  unreachable, !dbg !149
...
; <label>:6                                       ; preds = %3
  ...
  call void bitcast (i32 (...)* @klee_make_symbolic to void (i8*, i64, i8*)*)(i8* %7, i64 4, i8* %name) #7, !dbg !157
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2015-08-30-sdiv-1.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2015-08-30-sdiv-1.c]
...
!130 = metadata !{i32 786443, metadata !1, metadata !4, i32 14, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2015-08-30-sdiv-1.c]
!131 = metadata !{i32 15, i32 0, metadata !130, null}
!132 = metadata !{i32 16, i32 0, metadata !133, null}
!133 = metadata !{i32 786443, metadata !1, metadata !4, i32 16, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2015-08-30-sdiv-1.c]
!134 = metadata !{i32 17, i32 0, metadata !133, null}
!135 = metadata !{i32 18, i32 0, metadata !4, null}
