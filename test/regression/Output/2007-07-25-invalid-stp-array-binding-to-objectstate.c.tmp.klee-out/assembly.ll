; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2007-07-25-invalid-stp-array-binding-to-objectstate.c.tmp1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [10 x i8] c"c[0] > 10\00", align 1
@.str1 = private unnamed_addr constant [99 x i8] c"/home/sanghu/TracerX/tracerx/test/regression/2007-07-25-invalid-stp-array-binding-to-objectstate.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 ([2 x i8]*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 ([2 x i8]*, i64, ...)*)([2 x i8]* %c, i64 2)
  %3 = getelementptr inbounds [2 x i8]* %c, i32 0, i64 0
  %4 = load i8* %3, align 1
  %5 = sext i8 %4 to i32
  %6 = icmp sgt i32 %5, 10
...
; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds [2 x i8]* %c, i32 0, i64 1
  store i8 1, i8* %8, align 1
  %9 = getelementptr inbounds [2 x i8]* %c, i32 0, i64 0
...
; <label>:14                                      ; preds = %7
  call void @__assert_fail(i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([99 x i8]* @.str1, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #7
  unreachable
                                                  ; No predecessors!
  br label %16
