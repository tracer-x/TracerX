; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2007-08-16-valid-write-to-freed-object.c.tmp1.bc'
...
define i32 @sym() #0 {
  ...
  %1 = call i32 (i32*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, ...)*)(i32* %x, i64 4)
...
; <label>:4                                       ; preds = %0
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0))
  br label %6
