; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2008-05-23-gep-with-global-const.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@a = common global i32 0, align 4
@.str = private unnamed_addr constant [9 x i8] c"p1 == p2\00", align 1
@.str1 = private unnamed_addr constant [80 x i8] c"/home/sanghu/TracerX/tracerx/test/regression/2008-05-23-gep-with-global-const.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  store i8* getelementptr inbounds (i8* null, i64 ptrtoint (i32* @a to i64)), i8** %p1, align 8
  store i8* bitcast (i32* @a to i8*), i8** %p2, align 8
...
; <label>:6                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([80 x i8]* @.str1, i32 0, i32 0), i32 13, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6
  unreachable
                                                  ; No predecessors!
  br label %8
