; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2008-04-10-bad-alloca-free.c.tmp1.bc'
...
define void @f(i32* %addr) #0 {
  %1 = alloca i32*, align 8
  store i32* %addr, i32** %1, align 8
  %2 = load i32** %1, align 8
  %3 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %2, i64 4, i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0))
  ret void
}
