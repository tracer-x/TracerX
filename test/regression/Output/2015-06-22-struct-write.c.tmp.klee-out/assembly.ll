; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2015-06-22-struct-write.c.tmp.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [12 x i8] c"u.f3 == 534\00", align 1
@.str1 = private unnamed_addr constant [71 x i8] c"/home/sanghu/TracerX/tracerx/test/regression/2015-06-22-struct-write.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [23 x i8] c"int main(int, char **)\00", align 1
@u = internal global { i8, i8, i8, i8 } { i8 0, i8 0, i8 0, i8 undef }, align 4
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = load i24* bitcast ({ i8, i8, i8, i8 }* @u to i24*), align 4, !dbg !134
  %5 = and i24 %4, -262144, !dbg !134
  %6 = or i24 %5, 534, !dbg !134
  store i24 %6, i24* bitcast ({ i8, i8, i8, i8 }* @u to i24*), align 4, !dbg !134
  %7 = load i24* bitcast ({ i8, i8, i8, i8 }* @u to i24*), align 4, !dbg !135
  %int_cast_to_i64 = zext i24 6 to i64
  call void @klee_overshift_check(i64 24, i64 %int_cast_to_i64), !dbg !135
  %8 = shl i24 %7, 6, !dbg !135
  %int_cast_to_i641 = zext i24 6 to i64
  call void @klee_overshift_check(i64 24, i64 %int_cast_to_i641), !dbg !135
  %9 = ashr i24 %8, 6, !dbg !135
  %10 = sext i24 %9 to i32, !dbg !135
  %11 = icmp eq i32 %10, 534, !dbg !135
  br i1 %11, label %12, label %13, !dbg !135

; <label>:12                                      ; preds = %0
  br label %15, !dbg !135

; <label>:13                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([71 x i8]* @.str1, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([23 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) #6, !dbg !135
  unreachable, !dbg !135
                                                  ; No predecessors!
  br label %15, !dbg !135
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #7, !dbg !139
  unreachable, !dbg !139
...
define i32 @klee_int(i8* %name) #3 {
  ...
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #8, !dbg !141
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !149
  unreachable, !dbg !149
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #7, !dbg !154
  unreachable, !dbg !154
...
; <label>:6                                       ; preds = %3
  ...
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #8, !dbg !157
...
!llvm.dbg.cu = !{!0, !17, !28, !41, !53, !66, !85, !100, !115}
!llvm.module.flags = !{!131, !132}
!llvm.ident = !{!133, !133, !133, !133, !133, !133, !133, !133, !133}

!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.4.2 (tags/RELEASE_34/dot2-final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !12, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2015-06-22-struct-write.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 14, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i8**)* @main, null, null, metadata !2, i32 14} ; [ DW_TAG_sub
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2015-06-22-struct-write.c]
...
!13 = metadata !{i32 786484, i32 0, null, metadata !"u", metadata !"u", metadata !"", metadata !5, i32 12, metadata !14, i32 1, i32 1, { i8, i8, i8, i8 }* @u, null} ; [ DW_TAG_variable ] [u] [line 12] [local] [def]
!14 = metadata !{i32 786455, metadata !1, null, metadata !"U0", i32 8, i64 32, i64 32, i64 0, i32 0, null, metadata !15, i32 0, null, null, null} ; [ DW_TAG_union_type ] [U0] [line 8, size 32, align 32, offset 0] [def] [from ]
!15 = metadata !{metadata !16}
!16 = metadata !{i32 786445, metadata !1, metadata !14, metadata !"f3", i32 9, i64 18, i64 32, i64 0, i32 0, metadata !8} ; [ DW_TAG_member ] [f3] [line 9, size 18, align 32, offset 0] [from int]
...
!134 = metadata !{i32 15, i32 0, metadata !4, null}
!135 = metadata !{i32 17, i32 0, metadata !4, null}
!136 = metadata !{i32 19, i32 0, metadata !4, null}
