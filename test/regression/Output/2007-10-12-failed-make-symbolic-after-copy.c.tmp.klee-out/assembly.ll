; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2007-10-12-failed-make-symbolic-after-copy.c.tmp1.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, i8*, ...)*)(i32* %x, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0))
  %3 = load i32* %x, align 4
  %4 = icmp uge i32 %3, 4
  br i1 %4, label %5, label %7

; <label>:5                                       ; preds = %0
  %6 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %7

; <label>:7                                       ; preds = %5, %0
  %8 = load i32* %x, align 4
  %9 = zext i32 %8 to i64
  %10 = getelementptr inbounds [4 x i32]* %y, i32 0, i64 %9
...
; <label>:13                                      ; preds = %7
  %14 = call i32 ([4 x i32]*, i64, i8*, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 ([4 x i32]*, i64, i8*, ...)*)([4 x i32]* %y, i64 16, i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0))
  %15 = load i32* %x, align 4
  %16 = zext i32 %15 to i64
  %17 = getelementptr inbounds [4 x i32]* %y, i32 0, i64 %16
  %18 = load i32* %17, align 4
  %19 = icmp eq i32 %18, 0
  br i1 %19, label %20, label %22

; <label>:20                                      ; preds = %13
  %21 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %22
...
; <label>:23                                      ; preds = %7
  ...
  %26 = getelementptr inbounds [4 x i32]* %y, i32 0, i64 %25
  %27 = load i32* %26, align 4
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %29, label %31

; <label>:29                                      ; preds = %23
  %30 = call i32 (i32, ...)* bitcast (i32 (...)* @klee_silent_exit to i32 (i32, ...)*)(i32 0)
  br label %31
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str13, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str24, i64 0, i64 0)) #7, !dbg !123
  unreachable, !dbg !123
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #7, !dbg !133
  unreachable, !dbg !133
