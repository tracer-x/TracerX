; ModuleID = '/home/sanghu/TracerX/tracerx/test/regression/Output/2015-08-30-empty-constraints.c.tmp.bc'
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call i32 (i32*, i64, ...)* bitcast (i32 (...)* @klee_make_symbolic to i32 (i32*, i64, ...)*)(i32* %d, i64 4), !dbg !128
  %3 = load i32* %d, align 4, !dbg !129
  %4 = and i32 %3, 2, !dbg !129
  %int_cast_to_i64 = zext i32 4 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !129
  %5 = sdiv i32 %4, 4, !dbg !129
  %6 = icmp ne i32 %5, 0, !dbg !129
  br i1 %6, label %7, label %8, !dbg !129

; <label>:7                                       ; preds = %0
  store i32 1, i32* %1, !dbg !131
  br label %9, !dbg !131
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #6, !dbg !136
  unreachable, !dbg !136
...
!1 = metadata !{metadata !"/home/sanghu/TracerX/tracerx/test/regression/2015-08-30-empty-constraints.c", metadata !"/home/sanghu/TracerX/tracerx/test/regression"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 13, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 13} ; [ DW_TAG_subprogram ] [
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2015-08-30-empty-constraints.c]
...
!128 = metadata !{i32 16, i32 0, metadata !4, null}
!129 = metadata !{i32 19, i32 0, metadata !130, null}
!130 = metadata !{i32 786443, metadata !1, metadata !4, i32 19, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sanghu/TracerX/tracerx/test/regression//home/sanghu/TracerX/tracerx/test/regression/2015-08-30-empty-constraints.c]
!131 = metadata !{i32 20, i32 0, metadata !130, null}
!132 = metadata !{i32 21, i32 0, metadata !4, null}
