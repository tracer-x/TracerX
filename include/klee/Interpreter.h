...
public:
  ...
  virtual void
  incInstructionsDepthOnEarlyTermination(unsigned currentInstruction) = 0;
  virtual void incBranchingDepthOnErrorTermination(unsigned currentDepth) = 0;
  virtual void
  incInstructionsDepthOnErrorTermination(unsigned currentInstruction) = 0;
  virtual void incInstructionsDepthOnSubsumption(unsigned currentDepth) = 0;
  virtual void
