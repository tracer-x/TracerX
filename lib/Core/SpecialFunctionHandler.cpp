...
void
SpecialFunctionHandler::handleMemoCheck(ExecutionState &state,
                                        KInstruction *target,
                                        std::vector<ref<Expr> > &arguments) {
...
void
SpecialFunctionHandler::handleAddOverflow(ExecutionState &state,
                                          KInstruction *target,
                                          std::vector<ref<Expr> > &arguments) {
...
void
SpecialFunctionHandler::handleSubOverflow(ExecutionState &state,
                                          KInstruction *target,
                                          std::vector<ref<Expr> > &arguments) {
...
void
SpecialFunctionHandler::handleMulOverflow(ExecutionState &state,
                                          KInstruction *target,
                                          std::vector<ref<Expr> > &arguments) {
