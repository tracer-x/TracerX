...
//      ref2coeff[CONST_REF] = ref2coeff[CONST_REF] + coeff->getZExtValue() *
//      mul;
//      return true;
//    }
//    case Expr::Mul: {
...
//            (it->second == 1)
//                ? it->first
//                : MulExpr::create(ConstantExpr::create(it->second,
//                Expr::Int32),
//                                  it->first);
//        pos.push_back(tmp);
//      } else if (it->second < 0) {
...
//  TxPartitionHelper::getExprsFromAndExpr(e);
...
//
//  // combine expressions sharing 1 variable into 1 entry, others are kept in
//  ret
